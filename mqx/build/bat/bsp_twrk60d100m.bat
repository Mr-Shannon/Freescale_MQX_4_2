...
copy "%ROOTDIR%\config\twrk60d100m\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\twrk60d100m.h" "%OUTPUTDIR%\twrk60d100m.h" /Y
...
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk60d100m\Generated_Code\*" "%OUTPUTDIR%\Generated_Code\*"
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk60d100m\Sources\*" "%OUTPUTDIR%\Sources\*"
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\gcc_cw\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb\if_dev_khci.h" "%OUTPUTDIR%\if_dev_khci.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb\usb_bsp.h" "%OUTPUTDIR%\usb_bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\gcc_arm\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb\if_dev_khci.h" "%OUTPUTDIR%\if_dev_khci.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb\usb_bsp.h" "%OUTPUTDIR%\usb_bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\uv4\intflash.scf" "%OUTPUTDIR%\intflash.scf" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb\if_dev_khci.h" "%OUTPUTDIR%\if_dev_khci.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb\usb_bsp.h" "%OUTPUTDIR%\usb_bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\iar\intflash.icf" "%OUTPUTDIR%\intflash.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk60d100m\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
goto end_script
