...
IF NOT EXIST "%OUTPUTDIR%\." mkdir "%OUTPUTDIR%\."
copy "%ROOTDIR%\mqx\source\psp\cortex_a\cpu\SVF522R3MK4.h" "%OUTPUTDIR%\SVF522R3MK4.h" /Y
...
copy "%ROOTDIR%\mqx\source\include\tlsfbits.h" "%OUTPUTDIR%\tlsfbits.h" /Y
copy "%ROOTDIR%\mqx\source\include\tlsf_adaptation.h" "%OUTPUTDIR%\tlsf_adaptation.h" /Y
copy "%ROOTDIR%\mqx\source\psp\cortex_m\compiler\rv_ds5\asm_mac.h" "%OUTPUTDIR%\asm_mac.h" /Y
copy "%ROOTDIR%\mqx\source\psp\cortex_m\compiler\rv_ds5\comp.h" "%OUTPUTDIR%\comp.h" /Y
goto end_script
