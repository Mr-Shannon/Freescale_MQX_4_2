...
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf5225.h" "%OUTPUTDIR%\mcf5225.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf522x_usbotg.h" "%OUTPUTDIR%\mcf522x_usbotg.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf522xx_adc.h" "%OUTPUTDIR%\mcf522xx_adc.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf522xx_eport.h" "%OUTPUTDIR%\mcf522xx_eport.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf522xx_pit.h" "%OUTPUTDIR%\mcf522xx_pit.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf52xx_cfm.h" "%OUTPUTDIR%\mcf52xx_cfm.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf52xx_fcan.h" "%OUTPUTDIR%\mcf52xx_fcan.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf52xx_i2c.h" "%OUTPUTDIR%\mcf52xx_i2c.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf52xx_ictl.h" "%OUTPUTDIR%\mcf52xx_ictl.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf52xx_rtc.h" "%OUTPUTDIR%\mcf52xx_rtc.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf52xx_uart.h" "%OUTPUTDIR%\mcf52xx_uart.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf5xxx_fec.h" "%OUTPUTDIR%\mcf5xxx_fec.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf5xxx_minifb.h" "%OUTPUTDIR%\mcf5xxx_minifb.h" /Y
copy "%ROOTDIR%\mqx\source\psp\coldfire\mcf5xxx_qspi.h" "%OUTPUTDIR%\mcf5xxx_qspi.h" /Y
