...
copy "%ROOTDIR%\mqx\source\io\adc\kadc\adc_mk40.h" "%OUTPUTDIR%\adc_mk40.h" /Y
...
copy "%ROOTDIR%\config\kwikstikk40x256\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\flashx\freescale\flash_mk40.h" "%OUTPUTDIR%\flash_mk40.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\TSS_SystemSetup.h" "%OUTPUTDIR%\TSS_SystemSetup.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\kwikstik-k40x256.h" "%OUTPUTDIR%\kwikstik-k40x256.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\lcd\Fonts_LCD.h" "%OUTPUTDIR%\Fonts_LCD.h" /Y
copy "%ROOTDIR%\mqx\source\io\lcd\slcd_kwikstik-k40x256.h" "%OUTPUTDIR%\slcd_kwikstik-k40x256.h" /Y
copy "%ROOTDIR%\mqx\source\io\lcd\PounceTypes_v2.h" "%OUTPUTDIR%\PounceTypes_v2.h" /Y
...
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_kwikstikk40x256\Generated_Code\*" "%OUTPUTDIR%\Generated_Code\*"
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_kwikstikk40x256\Sources\*" "%OUTPUTDIR%\Sources\*"
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\gcc_cw\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\gcc_arm\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
copy "%ROOTDIR%\mqx\source\io\hmi\TSS\lib_cw_gcc\libTSS_KXX_M4.a" "%OUTPUTDIR%\tss.a" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\uv4\intflash.scf" "%OUTPUTDIR%\intflash.scf" /Y
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\iar\intflash.icf" "%OUTPUTDIR%\intflash.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\kwikstikk40x256\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
