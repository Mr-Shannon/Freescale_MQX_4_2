...
copy "%ROOTDIR%\config\twrk24f120m\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\twrk24f120m.h" "%OUTPUTDIR%\twrk24f120m.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\gcc_arm\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\uv4\intflash.scf" "%OUTPUTDIR%\intflash.scf" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\iar\intflash.icf" "%OUTPUTDIR%\intflash.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk24f120m\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
goto end_script
