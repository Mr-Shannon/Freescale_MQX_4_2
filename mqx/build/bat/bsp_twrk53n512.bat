...
copy "%ROOTDIR%\mqx\source\io\adc\kadc\adc_mk53.h" "%OUTPUTDIR%\adc_mk53.h" /Y
...
copy "%ROOTDIR%\config\twrk53n512\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\enet\macnet\macnet_mk53.h" "%OUTPUTDIR%\macnet_mk53.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\flashx\freescale\flash_mk53.h" "%OUTPUTDIR%\flash_mk53.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\TSS_SystemSetup.h" "%OUTPUTDIR%\TSS_SystemSetup.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\twrk53n512.h" "%OUTPUTDIR%\twrk53n512.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\lcd\lcd_twrk53n512.h" "%OUTPUTDIR%\lcd_twrk53n512.h" /Y
...
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk53n512\Generated_Code\*" "%OUTPUTDIR%\Generated_Code\*"
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk53n512\Sources\*" "%OUTPUTDIR%\Sources\*"
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\gcc_cw\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\gcc_arm\intflash.ld" "%OUTPUTDIR%\intflash.ld" /Y
copy "%ROOTDIR%\mqx\source\io\hmi\TSS\lib_cw_gcc\libTSS_KXX_M4.a" "%OUTPUTDIR%\tss.a" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\uv4\intflash.scf" "%OUTPUTDIR%\intflash.scf" /Y
...
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd_kn_prv.h" "%OUTPUTDIR%\usb_dcd_kn_prv.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb_dcd\usb_dcd.h" "%OUTPUTDIR%\usb_dcd.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\iar\intflash.icf" "%OUTPUTDIR%\intflash.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk53n512\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
