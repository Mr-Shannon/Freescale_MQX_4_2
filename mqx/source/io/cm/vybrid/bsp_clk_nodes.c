...
uint8_t is_physically_open_pll1_pfd1()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_D1_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD1_CLKGATE);
...
uint8_t open_clk_pll1_pfd1()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD1_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
    //             ANADIG_PLL1_PFD_PFD1_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
                ANADIG_PLL1_PFD_D1_STABLE)) {
        return 0;
    }
    else {
...
{
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD1_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD1_FRAC);
...
uint8_t set_freq_pll1_pfd1(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD1_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD1_FRAC, new_frac);
...
uint8_t is_physically_open_pll1_pfd2()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD2_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD2_CLKGATE);
...
uint8_t open_clk_pll1_pfd2()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD2_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
    //             ANADIG_PLL1_PFD_PFD2_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
                ANADIG_PLL1_PFD_PFD2_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD2_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD2_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll1_pfd2(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD2_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD2_FRAC, new_frac);
...
uint8_t is_physically_open_pll1_pfd3()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD3_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD3_CLKGATE);
...
uint8_t open_clk_pll1_pfd3()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD3_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
    //             ANADIG_PLL1_PFD_PFD3_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
                ANADIG_PLL1_PFD_PFD3_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD3_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD3_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll1_pfd3(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD3_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD3_FRAC, new_frac);
...
uint8_t is_physically_open_pll1_pfd4()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD4_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD4_CLKGATE);
...
uint8_t open_clk_pll1_pfd4()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD4_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
    //             ANADIG_PLL1_PFD_PFD4_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD,
                ANADIG_PLL1_PFD_PFD4_STABLE)) {
        return 0;
    }
...
uint8_t close_clk_pll1_pfd4()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL1_PFD,
            ANADIG_PLL1_PFD_PFD4_CLKGATE, 1U);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD4_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll1_pfd4(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD4_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL1_PFD, ANADIG_PLL1_PFD_PFD4_FRAC, new_frac);
...
uint8_t is_physically_open_pll2_pfd1()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD1_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD1_CLKGATE);
...
uint8_t open_clk_pll2_pfd1()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD1_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
    //             ANADIG_PLL2_PFD_PFD1_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
                ANADIG_PLL2_PFD_PFD1_STABLE)) {
        return 0;
    }
    else {
...
{
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD1_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD1_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll2_pfd1(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD1_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD1_FRAC, new_frac);
...
uint8_t is_physically_open_pll2_pfd2()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD2_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD2_CLKGATE);
...
uint8_t open_clk_pll2_pfd2()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD2_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
    //             ANADIG_PLL2_PFD_PFD2_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
                ANADIG_PLL2_PFD_PFD2_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD2_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD2_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll2_pfd2(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD2_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD2_FRAC, new_frac);
...
uint8_t is_physically_open_pll2_pfd3()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD3_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD3_CLKGATE);
...
uint8_t open_clk_pll2_pfd3()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD3_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
    //             ANADIG_PLL2_PFD_PFD3_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
                ANADIG_PLL2_PFD_PFD3_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD3_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD3_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll2_pfd3(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD3_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD3_FRAC, new_frac);
...
uint8_t is_physically_open_pll2_pfd4()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD4_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD4_CLKGATE);
...
uint8_t open_clk_pll2_pfd4()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD4_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
    //             ANADIG_PLL2_PFD_PFD4_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD,
                ANADIG_PLL2_PFD_PFD4_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL2_PFD,
            ANADIG_PLL2_PFD_PFD4_CLKGATE, 1U);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD4_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll2_pfd4(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD4_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL2_PFD, ANADIG_PLL2_PFD_PFD4_FRAC, new_frac);
...
uint8_t is_physically_open_pll3_pfd1()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD1_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD1_CLKGATE);
...
uint8_t open_clk_pll3_pfd1()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD1_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
    //             ANADIG_PLL3_PFD_PFD1_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
                ANADIG_PLL3_PFD_PFD1_STABLE)) {
        return 0;
    }
    else {
...
{
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD1_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD1_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll3_pfd1(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD1_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD1_FRAC, new_frac);
...
uint8_t is_physically_open_pll3_pfd2()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD2_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD2_CLKGATE);
...
uint8_t open_clk_pll3_pfd2()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD2_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
    //             ANADIG_PLL3_PFD_PFD2_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
                ANADIG_PLL3_PFD_PFD2_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD2_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD2_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll3_pfd2(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD2_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD2_FRAC, new_frac);
...
uint8_t is_physically_open_pll3_pfd3()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD3_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD3_CLKGATE);
...
uint8_t open_clk_pll3_pfd3()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD3_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
    //             ANADIG_PLL3_PFD_PFD3_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
                ANADIG_PLL3_PFD_PFD3_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD3_CLKGATE, 1);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD3_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll3_pfd3(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD3_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD3_FRAC, new_frac);
...
uint8_t is_physically_open_pll3_pfd4()
{
    ...
    pfd_stable = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD4_STABLE);
    pfd_cg = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD4_CLKGATE);
...
uint8_t open_clk_pll3_pfd4()
{
    ...
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD4_CLKGATE, 0);
    // WAIT(EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
    //             ANADIG_PLL3_PFD_PFD4_STABLE), TIMEOUT);
    if (!EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD,
                ANADIG_PLL3_PFD_PFD4_STABLE)) {
        return 0;
    }
...
{
    INS_BITFIELD(s_reg_anadig->PLL3_PFD,
            ANADIG_PLL3_PFD_PFD4_CLKGATE, 1U);
...
{
    uint8_t frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD4_FRAC);
    p_self->freq = (uint64_t)parent_freq * 18 / frac;
    return 1;
}
...
uint8_t set_freq_pll3_pfd4(P_CLK_NODE_T p_self, va_list args, uint8_t* old_val, uint8_t* new_val)
{
    ...
    // Args Check
    numArgs = va_arg(args, int);
    old_frac = EXTRACT_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD4_FRAC);
    if (numArgs != 1) {
        printf("Freq Configuration Register for [%s] are:\n", clk_name_str(p_self->name));
    ...
    // Fill the register
    INS_BITFIELD(s_reg_anadig->PLL3_PFD, ANADIG_PLL3_PFD_PFD4_FRAC, new_frac);
