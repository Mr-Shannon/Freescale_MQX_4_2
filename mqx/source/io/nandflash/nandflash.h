...
#define NANDFLASHERR_DMA_NOT_ALIGNED         (NANDFLASH_ERROR_BASE | 0x0A)
...
/* NANDFLASH DEVIF STRUCTURE */
typedef struct nandflash_devif_struct
{
   /* The function to call to initialize the NAND flash device, if needed */
   uint32_t (_CODE_PTR_           INIT)(struct io_nandflash_struct *);
   ...
   _mqx_int (_CODE_PTR_           IOCTL)(IO_NANDFLASH_STRUCT_PTR, 
      _mqx_uint, void *);
} NANDFLASH_DEVIF_STRUCT, * NANDFLASH_DEVIF_STRUCT_PTR;

typedef const NANDFLASH_DEVIF_STRUCT * NANDFLASH_DEVIF_STRUCT_CPTR;
...
typedef struct nandflash_init_struct
{
   ...
   NANDFLASH_DEVIF_STRUCT_CPTR   DEVIF_INIT;
