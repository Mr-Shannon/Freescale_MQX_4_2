...
{ /* Body */
   ...
   dev_ptr->INIT                 = init_ptr->DEVIF_INIT->INIT;
   dev_ptr->DEINIT               = init_ptr->DEVIF_INIT->DEINIT;
   dev_ptr->CHIP_ERASE           = init_ptr->DEVIF_INIT->CHIP_ERASE;
   dev_ptr->BLOCK_ERASE          = init_ptr->DEVIF_INIT->BLOCK_ERASE;
   dev_ptr->PAGE_READ            = init_ptr->DEVIF_INIT->PAGE_READ;
   dev_ptr->PAGE_PROGRAM         = init_ptr->DEVIF_INIT->PAGE_PROGRAM;
   dev_ptr->WRITE_PROTECT        = init_ptr->DEVIF_INIT->WRITE_PROTECT;
   dev_ptr->IS_BLOCK_BAD         = init_ptr->DEVIF_INIT->IS_BLOCK_BAD;
   dev_ptr->MARK_BLOCK_AS_BAD    = init_ptr->DEVIF_INIT->MARK_BLOCK_AS_BAD;
   dev_ptr->IOCTL                = init_ptr->DEVIF_INIT->IOCTL;
