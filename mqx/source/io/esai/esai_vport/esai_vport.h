...
/*
** The command gets the tx buffer status of ESAI VPORT node
** Parameter: Buffer status
*/
#define IO_IOCTL_ESAI_VPORT_GET_TX_STATUS    _IO(IO_TYPE_ESAI_VPORT, 0x0E)

/*
** The command gets the rx buffer status of ESAI VPORT node
** Parameter: Buffer status
*/
#define IO_IOCTL_ESAI_VPORT_GET_RX_STATUS    _IO(IO_TYPE_ESAI_VPORT, 0x0F)

/*
** The command sets the tx timeout value to the ESAI VPORT node
** Parameter: NULL
*/
#define IO_IOCTL_ESAI_VPORT_UPDATE_TX_STATUS    _IO(IO_TYPE_ESAI_VPORT, 0x10)

/*
** The command sets the tx timeout value to the ESAI VPORT node
** Parameter: NULL
*/
#define IO_IOCTL_ESAI_VPORT_UPDATE_RX_STATUS    _IO(IO_TYPE_ESAI_VPORT, 0x11)

/*
** The command sets the tx timeout value to the ESAI VPORT node
** Parameter: NULL
*/
#define IO_IOCTL_ESAI_VPORT_WAIT_TX_EVENT    _IO(IO_TYPE_ESAI_VPORT, 0x12)

/*
** The command sets the tx timeout value to the ESAI VPORT node
** Parameter: NULL
*/
#define IO_IOCTL_ESAI_VPORT_WAIT_RX_EVENT    _IO(IO_TYPE_ESAI_VPORT, 0x13)
