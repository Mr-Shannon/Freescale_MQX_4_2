...
extern uint32_t _mcf52xx_i2c_polled_deinit (IO_I2C_POLLED_DEVICE_STRUCT_PTR, VMCF52XX_I2C_INFO_STRUCT_PTR);
extern uint32_t _mcf52xx_i2c_polled_rx (IO_I2C_POLLED_DEVICE_STRUCT_PTR, unsigned char *, uint32_t);
extern uint32_t _mcf52xx_i2c_polled_tx (IO_I2C_POLLED_DEVICE_STRUCT_PTR, unsigned char *, uint32_t);
extern uint32_t _mcf52xx_i2c_polled_ioctl (VMCF52XX_I2C_INFO_STRUCT_PTR, uint32_t, uint32_t *);
static uint8_t  _mcf52xx_i2c_find_baud_index (uint32_t);
static uint32_t _mcf52xx_i2c_polled_rx_tx (VMCF52XX_I2C_STRUCT_PTR, VMCF52XX_I2C_INFO_STRUCT_PTR, unsigned char *, uint32_t);
...
static uint8_t _mcf52xx_i2c_find_baud_index 
   (
      /* [IN] Desired baudrate */
      uint32_t input_baud
   )
...
uint32_t _mcf52xx_i2c_polled_init
   (
...
{ /* Body */
   ...
   io_info_ptr = (VMCF52XX_I2C_INFO_STRUCT_PTR)_mem_alloc_system_zero ((uint32_t)sizeof (MCF52XX_I2C_INFO_STRUCT));
   if (NULL == io_info_ptr) 
   {
...
uint32_t _mcf52xx_i2c_polled_ioctl
   (
      /* [IN] the address of the device specific information */
      VMCF52XX_I2C_INFO_STRUCT_PTR io_info_ptr,
...
uint32_t _mcf52xx_i2c_polled_rx
   (
      /* [IN] the address of the device specific information */
      IO_I2C_POLLED_DEVICE_STRUCT_PTR pol_io_dev_ptr,
...
uint32_t _mcf52xx_i2c_polled_tx
   (
      /* [IN] the address of the device specific information */
      IO_I2C_POLLED_DEVICE_STRUCT_PTR pol_io_dev_ptr,
...
static uint32_t _mcf52xx_i2c_polled_rx_tx
   (
