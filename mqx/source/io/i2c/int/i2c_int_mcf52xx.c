...
extern uint32_t _mcf52xx_i2c_polled_init (MCF52XX_I2C_INIT_STRUCT_PTR, void **, char *);
extern uint32_t _mcf52xx_i2c_polled_ioctl (VMCF52XX_I2C_INFO_STRUCT_PTR, uint32_t, uint32_t *);

extern uint32_t _mcf52xx_i2c_int_init (IO_I2C_INT_DEVICE_STRUCT_PTR, char *);
extern uint32_t _mcf52xx_i2c_int_deinit (IO_I2C_INT_DEVICE_STRUCT_PTR, VMCF52XX_I2C_INFO_STRUCT_PTR);
extern uint32_t _mcf52xx_i2c_int_rx (IO_I2C_INT_DEVICE_STRUCT_PTR, unsigned char *, uint32_t);
extern uint32_t _mcf52xx_i2c_int_tx (IO_I2C_INT_DEVICE_STRUCT_PTR, unsigned char *, uint32_t);
static void    _mcf52xx_i2c_isr (void *);
...
uint32_t _mcf52xx_i2c_int_install
   (
...
{ /* Body */
   ...
   return _io_i2c_int_install(identifier,
      (_mqx_uint (_CODE_PTR_)(void *, char *))_mcf52xx_i2c_int_init,
      (_mqx_uint (_CODE_PTR_)(void *, void *))_mcf52xx_i2c_int_deinit,
      (_mqx_int (_CODE_PTR_)(void *, char *, _mqx_int))_mcf52xx_i2c_int_rx,
      (_mqx_int (_CODE_PTR_)(void *, char *, _mqx_int))_mcf52xx_i2c_int_tx,
...
uint32_t _mcf52xx_i2c_int_init
   (
...
{ /* Body */
   ...
   io_info_ptr->OLD_ISR = _int_install_isr (vector, _mcf52xx_i2c_isr, (void *)io_info_ptr);
...
uint32_t _mcf52xx_i2c_int_deinit
   (
