...
{ /* Body */
    if (dev_data_ptr->type == DEV_OUTPUT) { /* set GPIO output behavior */
        * (((uint32_t *) (&mcf5225_gpio_ptr->DDRTE)) + 0) |= dev_data_ptr->pin_map.memory32[0];
        * (((uint32_t *) (&mcf5225_gpio_ptr->DDRTE)) + 1) |= dev_data_ptr->pin_map.memory32[1];
        * (((uint32_t *) (&mcf5225_gpio_ptr->DDRTE)) + 2) |= dev_data_ptr->pin_map.memory32[2];
        * (((uint32_t *) (&mcf5225_gpio_ptr->DDRTE)) + 3) |= dev_data_ptr->pin_map.memory32[3];
        * (((uint32_t *) (&mcf5225_gpio_ptr->DDRTE)) + 4) |= dev_data_ptr->pin_map.memory32[4];
        * (((uint32_t *) (&mcf5225_gpio_ptr->DDRTE)) + 5) |= dev_data_ptr->pin_map.memory32[5];
    }
...
{ /* Body */
    ...
    if ((param_ptr != NULL) && (dev_data_ptr->type == DEV_OUTPUT)) { /* set pins status before selecting GPIO function */
        ...
        * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 0) = temp_pin1_map_ptr->memory32[0];
        * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 0) = ~temp_pin0_map_ptr->memory32[0];
        * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 1) = temp_pin1_map_ptr->memory32[1];
        * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 1) = ~temp_pin0_map_ptr->memory32[1];
        * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 2) = temp_pin1_map_ptr->memory32[2];
        * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 2) = ~temp_pin0_map_ptr->memory32[2];
        * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 3) = temp_pin1_map_ptr->memory32[3];
        * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 3) = ~temp_pin0_map_ptr->memory32[3];
        * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 4) = temp_pin1_map_ptr->memory32[4];
        * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 4) = ~temp_pin0_map_ptr->memory32[4];
        * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 5) = temp_pin1_map_ptr->memory32[5];
        * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 5) = ~temp_pin0_map_ptr->memory32[5];
    ...
    switch (cmd) {
        ...
        /* If this file is configured as output, sets every pin to 1. Params:
           list of pin addresses to be used or NULL for every pin in the file */
            ...
            if (param_ptr == NULL) { /* apply command to whole file */
                ...
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 0) = dev_data_ptr->pin_map.memory32[0];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 1) = dev_data_ptr->pin_map.memory32[1];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 2) = dev_data_ptr->pin_map.memory32[2];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 3) = dev_data_ptr->pin_map.memory32[3];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 4) = dev_data_ptr->pin_map.memory32[4];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 5) = dev_data_ptr->pin_map.memory32[5];
                ...
                /* ok, now we can apply new map */
                /* note: applying the map after collecting pins is due to have pins applied in one instruction */
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 0) = temp_pin_map_ptr->memory32[0];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 1) = temp_pin_map_ptr->memory32[1];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 2) = temp_pin_map_ptr->memory32[2];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 3) = temp_pin_map_ptr->memory32[3];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 4) = temp_pin_map_ptr->memory32[4];
                * (((uint32_t *) (&mcf5225_gpio_ptr->PORTTEP_SETTE)) + 5) = temp_pin_map_ptr->memory32[5];
                _int_enable();
                _mem_free(temp_pin_map_ptr);
            }
        }
        ...
        /* If this file is configured as output, clears every pin to 0. Params:
           list of pin addresses to be used or NULL for every pin in the file */
            ...
            if (param_ptr == NULL) { /* apply command to whole file */
                _int_disable(); /* _lwsem_wait(&gpio_sem) replacement */
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 0) = ~dev_data_ptr->pin_map.memory32[0];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 1) = ~dev_data_ptr->pin_map.memory32[1];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 2) = ~dev_data_ptr->pin_map.memory32[2];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 3) = ~dev_data_ptr->pin_map.memory32[3];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 4) = ~dev_data_ptr->pin_map.memory32[4];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 5) = ~dev_data_ptr->pin_map.memory32[5];
                _int_enable(); /* _int_enable(); */
                break;
            }
            else {
                ...
                /* ok, now we can apply new map */
                /* note: applying the map after collecting pins is due to have pins applied in one instruction */
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 0) = ~temp_pin_map_ptr->memory32[0];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 1) = ~temp_pin_map_ptr->memory32[1];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 2) = ~temp_pin_map_ptr->memory32[2];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 3) = ~temp_pin_map_ptr->memory32[3];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 4) = ~temp_pin_map_ptr->memory32[4];
                * (((uint32_t *) (&mcf5225_gpio_ptr->CLRTE)) + 5) = ~temp_pin_map_ptr->memory32[5];
                _int_enable();
                _mem_free(temp_pin_map_ptr);
            }
        }
                    ...
                    if (addr < sizeof(GPIO_PIN_MAP)) /* pin address out of map scope? */
                        if (dev_data_ptr->pin_map.memory8[addr] & pin) { /* pin address already used? */
                            if ((addr == 8) && (gpio_global_irq_map.memory8[addr] & 0xAA & pin)) { /* EPORT port and pin 1, 3, 5, or 7 */
                                if ( *(((uint8_t *) &mcf5225_eport_ptr->EPPDR)) & pin) /* check pin status */
                                ...
                                if ( *(((uint8_t *) &mcf5225_gpio_ptr->PORTTEP_SETTE) + addr) & pin) /* check pin status */
                                    *pin_table |= GPIO_PIN_STATUS; /* set pin status to 1 in the list */
                                else
                                    *pin_table &= ~GPIO_PIN_STATUS; /* clear pin status to 0 in the list */
                                continue; /* manage next pin */
...
{
    return (void *)(&((VMCF5225_STRUCT_PTR)_PSP_GET_IPSBAR())->GPIO);
}
