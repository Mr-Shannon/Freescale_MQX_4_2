...
} MCF54XX_UART_SERIAL_INIT_STRUCT, * MCF54XX_UART_SERIAL_INIT_STRUCT_PTR;
typedef const MCF54XX_UART_SERIAL_INIT_STRUCT * MCF54XX_UART_SERIAL_INIT_STRUCT_CPTR;
...
} MCF54XX_UART_SERIAL_INFO_STRUCT, * MCF54XX_UART_SERIAL_INFO_STRUCT_PTR;
...
extern uint32_t _mcf54xx_uart_serial_polled_init(MCF54XX_UART_SERIAL_INIT_STRUCT_PTR,void **,char *);
extern uint32_t _mcf54xx_uart_serial_polled_install(char *, MCF54XX_UART_SERIAL_INIT_STRUCT_CPTR, uint32_t);
extern uint32_t _mcf54xx_uart_serial_int_install(char *, MCF54XX_UART_SERIAL_INIT_STRUCT_CPTR, uint32_t);
