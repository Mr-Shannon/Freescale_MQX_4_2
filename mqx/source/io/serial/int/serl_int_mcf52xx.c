...
extern uint32_t _mcf52xx_uart_serial_int_init(IO_SERIAL_INT_DEVICE_STRUCT_PTR,
 char *);
extern uint32_t _mcf52xx_uart_serial_int_deinit(MCF52XX_UART_SERIAL_INIT_STRUCT_PTR,
   MCF52XX_UART_SERIAL_INFO_STRUCT_PTR);
extern uint32_t _mcf52xx_uart_serial_int_enable(MCF52XX_UART_SERIAL_INFO_STRUCT_PTR);
extern void    _mcf52xx_uart_serial_int_isr(void *);
...
uint32_t _mcf52xx_uart_serial_int_install
   (
...
{ /* Body */
   ...
   return _io_serial_int_install(identifier,
      (uint32_t (_CODE_PTR_)(void *, char *))_mcf52xx_uart_serial_int_init,
      (uint32_t (_CODE_PTR_)(void *))_mcf52xx_uart_serial_int_enable,
      (uint32_t (_CODE_PTR_)(void *,void *))_mcf52xx_uart_serial_int_deinit,
      (void    (_CODE_PTR_)(void *, char))_mcf52xx_uart_serial_int_putc,
...
uint32_t _mcf52xx_uart_serial_int_init
   (
...
{ /* Body */
   ...
   result = _mcf52xx_uart_serial_polled_init((void *)uart_init_ptr,
...
uint32_t _mcf52xx_uart_serial_int_deinit
   (
      /* [IN] the interrupt I/O initialization information */
...
uint32_t _mcf52xx_uart_serial_int_enable
   (
      /* [IN] the address of the device specific information */
      MCF52XX_UART_SERIAL_INFO_STRUCT_PTR io_info_ptr
   )
...
/* End CR 2087 */      
   ...
   if (status == MQX_OK) {
//      volatile MCF52XX_STRUCT           *mcf52XX_ptr = io_info_ptr->MCF52XX_PTR;
      volatile MCF52XX_UART_STRUCT      *uart_ptr = io_info_ptr->UART_PTR;
