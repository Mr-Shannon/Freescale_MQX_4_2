...
/* EXTAL RMII clock is used for clocking the 1588 timer */
#if defined (BSP_TWR_VF65GS10_A5) || defined (BSP_TWR_VF65GS10_M4)
#define MACNET_1588_CLOCK_SRC      (BSP_EXTAL_RMII_REF_CLOCK)
#elif defined (BSP_SVF522REVB_A5) || defined (BSP_SVF522REVB_M4)
#define MACNET_1588_CLOCK_SRC      (BSP_PLL5_ENET_CLOCK)
#endif
