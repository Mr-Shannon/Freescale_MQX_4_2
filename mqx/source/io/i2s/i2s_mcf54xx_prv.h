#ifndef _i2s_mcf54xx_prv_h
#define _i2s_mcf54xx_prv_h
/*HEADER**********************************************************************
*
...
*/
typedef struct mcf54xx_i2s_buffer
{
    /* Pointer to data */
    uint32_t *DATA;
...
} MCF54XX_I2S_BUFFER, * MCF54XX_I2S_BUFFER_PTR;

/*
**
*/
typedef struct mcf54xx_i2s_dummy_data
{
...
} MCF54XX_I2S_DUMMY_DATA, *  MCF54XX_I2S_DUMMY_DATA_PTR;
...
/*
** MCF54XX_I2S_INFO_STRUCT
** I2S run time state information
*/
typedef struct mcf54xx_i2s_info_struct
{
    /* Current initialized values */
    MCF54XX_I2S_INIT_STRUCT  INIT;

    VMCF5441_SSI_STRUCT_PTR  I2S_PTR;
...
} MCF54XX_I2S_INFO_STRUCT, * MCF54XX_I2S_INFO_STRUCT_PTR;
