...
extern PSP_INTERRUPT_TABLE_INDEX _bsp_get_flexcan_vector (uint8_t,uint8_t,uint32_t);
extern bool _bsp_flexcan_enable_access(uint32_t device);
...
extern uint32_t FLEXCAN_Install_isr_ex(uint8_t,uint32_t,INT_ISR_FPTR,void *);
