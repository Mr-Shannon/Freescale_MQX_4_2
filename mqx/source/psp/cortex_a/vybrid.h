...
#if (((MQX_CPU >> 4 & PSP_CPU_GROUP_VYBRID_A5) == PSP_CPU_GROUP_VYBRID_A5) || \
     ((MQX_CPU >> 4 & PSP_CPU_GROUP_VYBRID_M4) == PSP_CPU_GROUP_VYBRID_M4))
	
    #if MQX_CPU == PSP_CPU_VF65GS10_A5 || MQX_CPU == PSP_CPU_VF65GS10_M4
            #include "MVF61NS151MK50.h"
    #elif MQX_CPU == PSP_CPU_SVF522R3K_A5 || MQX_CPU == PSP_CPU_SVF522R3K_M4	 
...
#define SEMA4_NUM_DEVICES               1
    ...
    #if MQX_CPU == PSP_CPU_VF65GS10_A5 && !defined(PSP_HAS_L2_CACHE)
    ...
    #endif
#elif ((MQX_CPU >> 4 & PSP_CPU_GROUP_VYBRID_M4) == PSP_CPU_GROUP_VYBRID_M4)
    #ifndef PSP_HAS_CODE_CACHE
    #define PSP_HAS_CODE_CACHE          1
    #endif
...
#define GICD_ISPENDR_REG(base, idx)     ((base)->ISPENDR[idx])
...
#define GICD_ISPENDR(idx)               GICD_ISPENDR_REG(GICD_BASE_PTR, (idx))
