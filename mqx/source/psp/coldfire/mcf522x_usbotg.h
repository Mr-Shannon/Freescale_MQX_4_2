...
{   
    unsigned char   PER_ID;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler0[3];
    unsigned char   ID_COMP;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler1[3];
    unsigned char   REV;          // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler2[3];
    unsigned char   ADD_INFO;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler3[3];
    unsigned char   OTG_INT_STAT; // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler4[3];
    unsigned char   OTG_INT_EN;   // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler5[3];
    unsigned char   OTG_STATUS;   // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler6[3];
    unsigned char   OTG_CTRL;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler7[99];
    unsigned char   INT_STAT;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler8[3];
    unsigned char   INT_ENB;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler9[3];
    unsigned char   ERR_STAT;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler10[3];
    unsigned char   ERR_ENB;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler11[3];
    unsigned char   STAT;         // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler12[3];
    unsigned char   CTL;          // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler13[3];
    unsigned char   ADDR;         // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler14[3];
    unsigned char   BDT_PAGE_01;  // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler15[3];
    unsigned char   FRM_NUML;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler16[3];
    unsigned char   FRM_NUMH;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler17[3];
    unsigned char   TOKEN;        // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler18[3];
    unsigned char   SOF_THLD;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler19[3];
    unsigned char   BDT_PAGE_02;  // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler20[3];
    unsigned char   BDT_PAGE_03;  // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler21[11];
    unsigned char   ENDPT0;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler22[3];
    unsigned char   ENDPT1;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler23[3];
    unsigned char   ENDPT2;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler24[3];
    unsigned char   ENDPT3;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler25[3];
    unsigned char   ENDPT4;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler26[3];
    unsigned char   ENDPT5;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler27[3];
    unsigned char   ENDPT6;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler28[3];
    unsigned char   ENDPT7;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler29[3];
    unsigned char   ENDPT8;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler30[3];
    unsigned char   ENDPT9;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler31[3];
    unsigned char   ENDPT10;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler32[3];
    unsigned char   ENDPT11;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler33[3];
    unsigned char   ENDPT12;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler34[3];
    unsigned char   ENDPT13;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler35[3];
    unsigned char   ENDPT14;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler36[3];
    unsigned char   ENDPT15;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler37[3];
    unsigned char   USB_CTRL;     // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler38[3];
    unsigned char   USB_OTG_OBSERVE; // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler39[3];
    unsigned char   USB_OTG_CONTROL; // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler40[3];
    unsigned char   USBTRC0;      // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler41[3];
    unsigned char   OTGPIN;       // OBSOLETE, use USB_MemMap instead!
    unsigned char   filler42[3]; 
} MCF522X_USBOTG_STRUCT, * MCF522X_USBOTG_STRUCT_PTR;
