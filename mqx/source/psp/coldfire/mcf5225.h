...
#define MCF5225_CS_CSAR_BA(a)                   (uint16_t)(((a)&0xFFFF0000)>>16)
...
{
   uint32_t  IPSBAR;         // Module base address register
   uint32_t  filler1;        // FLASH base address register   
   uint32_t  RAMBAR;         // RAM base address register
   uint32_t  PPMRH;          // Peripheral Power Management Register High
   unsigned char    CRSR;           // Core reset status register
   unsigned char    CWCR;           // Core watchdog control register
   unsigned char    LPICR;          // Low Power Interrupt Control Register
   unsigned char    CWSR;           // Core watchdog service register
   uint32_t  DMAREQC;        // DMA Request Control Register
   uint32_t  PPMRL;          // Peripheral Power Management Register - Low
   uint32_t  MPARK;          // Default Bus Master Park Register
   unsigned char    MPR;            // Master Privilege Register
   unsigned char    PPMRS;          // Peripheral Power Management Set Register
   unsigned char    PPMRC;          // Peripheral Power Management Clear Register
   unsigned char    IPSBMT;         // IPS Bus Timeout Monitor Register
   unsigned char    PACR0;          // Peripheral Access Control Register 0
   unsigned char    PACR1;          // Peripheral Access Control Register 1
   unsigned char    PACR2;          // Peripheral Access Control Register 2
   unsigned char    PACR3;          // Peripheral Access Control Register 3
   unsigned char    PACR4;          // Peripheral Access Control Register 4
   unsigned char    PACR5;          // Peripheral Access Control Register 5
   unsigned char    PACR6;          // Peripheral Access Control Register 6
   unsigned char    PACR7;          // Peripheral Access Control Register 7
   unsigned char    PACR8;          // Peripheral Access Control Register 8
   unsigned char    PACR9;          // Peripheral Access Control Register 9
   unsigned char    PACR10;         // Peripheral Access Control Register 10 
   unsigned char    filler;
   unsigned char    GPACR0;         // Grouped Peripheral Access Control Register 0 
   unsigned char    GPACR1;         // Grouped Peripheral Access Control Register 1
   unsigned char    filler3[0x0040 - 0x0031 - 1];
 } MCF5225_SCM_STRUCT, * MCF5225_SCM_STRUCT_PTR;
typedef volatile struct MCF5225_scm_struct * VMCF5225_SCM_STRUCT_PTR;
...
typedef struct mcf5225_dma_struct
{
   ...
   uint32_t  BCR;            // DMA status register
   uint32_t  DCR;            // DMA control register
} MCF5225_DMA_STRUCT, * MCF5225_DMA_STRUCT_PTR;
typedef volatile struct mcf5225_dma_struct * VMCF5225_DMA_STRUCT_PTR;
...
typedef struct mcf5225_dma_timer_struct
{
   ...
   unsigned char    DTXTMR;         // DMA Timer extended mode register
   unsigned char    DTER;           // DMA Timer event register
...
} MCF5225_DMA_TIMER_STRUCT, * MCF5225_DMA_TIMER_STRUCT_PTR;
typedef volatile struct mcf5225_dma_timer_struct * VMCF5225_DMA_TIMER_STRUCT_PTR;
...
typedef struct mcf5225_gpio_struct
{
   /* Port Output Data Registers */
    unsigned char   PORTTE, PORTTF, PORTTG, PORTTH; 
    unsigned char   PORTTI, filler1, PORTTJ, filler2; 
    unsigned char   PORTNQ, filler3, PORTAN, PORTAS; 
    unsigned char   PORTQS, filler4, PORTTA, PORTTC; 
    unsigned char   filler5, PORTUA, PORTUB, PORTUC; 
    unsigned char   PORTDD, filler6[3];     
   /* Port Data Direction Registers */
    unsigned char   DDRTE, DDRTF, DDRTG, DDRTH; 
    unsigned char   DDRTI, filler7, DDRTJ, filler8; 
    unsigned char   DDRNQ, filler9, DDRAN, DDRAS; 
    unsigned char   DDRQS, filler10, DDRTA, DDRTC; 
    unsigned char   filler11, DDRUA, DDRUB, DDRUC; 
    unsigned char   DDRDD, filler12[3];
   /* Port Pin Data/Set Data Registers */
    unsigned char   PORTTEP_SETTE, PORTTFP_SETTF, PORTTGP_SETTG, PORTTHP_SETTH; 
    unsigned char   PORTTIP_SETTI, filler13, PORTTJP_SETTJ, filler14; 
    unsigned char   PORTNQP_SETNQ, filler15, PORTANP_SETAN, PORTASP_SETAS; 
    unsigned char   PORTQSP_SETQS, filler16, PORTTAP_SETTA, PORTTCP_SETTC; 
    unsigned char   filler17, PORTUAP_SETUA, PORTUBP_SETUB, PORTUCP_SETUC; 
    unsigned char   PORTDDP_SETDD, filler18[3]; 
   /* Port Clear Output Data Registers */
    unsigned char   CLRTE, CLRTF, CLRTG, CLRTH; 
    unsigned char   CLRTI, filler19, CLRTJ, filler20; 
    unsigned char   CLRNQ, filler21, CLRAN, CLRAS; 
    unsigned char   CLRQS, filler22, CLRTA, CLRTC; 
    unsigned char   filler23, CLRUA, CLRUB, CLRUC; 
    unsigned char   CLRDD, filler24[3]; 
   /* Port Pin Assignment Registers */
   unsigned char    PTEPAR, PTFPAR, PTGPAR, filler25;
   unsigned char    PTIPAR, filler26, PTJPAR, filler27;
   uint16_t  PNQPAR;
   unsigned char    PANPAR, PASPAR;
   uint16_t  PQSPAR;
   unsigned char    PTAPAR, PTCPAR;
   unsigned char    filler28, PUAPAR, PUBPAR, PUCPAR;
   unsigned char    PDDPAR, filler29[2], CLKOUTPAR;
   /* Port Pad Control Registers */
   
   uint32_t  PSRR;
   uint32_t  PDSR;           // Pin Drive Strength Register [31:0]
   uint32_t  PSRRL;
   uint16_t  filler30, PSRRH;
   uint32_t  PDSRL;
   uint16_t  filler31, PDSRH;
   uint16_t  PTHPAR, filler32;
            
   unsigned char    filler33[0xFF6C];
}  MCF5225_GPIO_STRUCT, * MCF5225_GPIO_STRUCT_PTR;
typedef volatile struct mcf5225_gpio_struct * VMCF5225_GPIO_STRUCT_PTR;
...
{
   unsigned char    RCR;            // Reset control register
   unsigned char    RSR;            // Reset status register
   unsigned char    filler1[2];
   uint16_t  CCR;            // Chip Configuration Register
   unsigned char    filler2;
   unsigned char    LPCR;           // Low-Power Control Register
   uint16_t  RCON;           // Reset Configuration Register
   uint16_t  CIR;            // Chip Identification Register
   unsigned char    filler3[4];
   uint16_t  CCE;            // Chip Identification Extended Register
   unsigned char    filler4[0xFFEE];
} MCF5225_CCM_STRUCT, * MCF5225_CCM_STRUCT_PTR;
typedef volatile struct mcf5225_ccm_struct * VMCF5225_CCM_STRUCT_PTR;
...
{
   uint16_t  SYNCR;          // Synthesizer control register
   unsigned char    SYNSR;          // Synthesizer status register
   unsigned char    filler0;        // SYNTR Synthesizer test register
   uint16_t  ROCR;
   ...
   unsigned char    OCHR;
   unsigned char    OCLR;
   unsigned char    filler2[6];
   unsigned char    RTCCR;
   unsigned char    BWCR; 
   unsigned char    filler4[0xFFEB];
} MCF5225_CLK_STRUCT, * MCF5225_CLK_STRUCT_PTR;
typedef volatile struct mcf5225_clk_struct * VMCF5225_CLK_STRUCT_PTR;
...
typedef struct mcf5225_watchdog_struct
{
   ...
   uint16_t  WMR;            // Watchdog modulus register
   uint16_t  WCNTR;          // Watchdog count register
   uint16_t  WSR;            // Watchdog service register
   unsigned char   filler[0xFFF8];
} MCF5225_WATCHDOG_STRUCT, * MCF5225_WATCHDOG_STRUCT_PTR;
typedef volatile struct mcf5225_watchdog_struct * VMCF5225_WATCHDOG_STRUCT_PTR;
...
{   
   unsigned char    GPTIOS;         // GPT IC/OC Select Register
   unsigned char    GPTCFORC;       // GPT Compare Force Register      
   unsigned char    GPTOC3M;        // GPT Output Compare 3 Mask Register
   unsigned char    GPTOC3D;        // GPT Output Compare 3 Data Register
   uint16_t  GPTCNT;         // GPT Counter Register
   unsigned char    GPTSCR1;        // GPT System Control Register 1
   unsigned char    filler1;
   unsigned char    GPTTOV;         // GPT Toggle-on-Overflow Register
   unsigned char    GPTCTL1;        // GPT Control Register 1
   unsigned char    filler2; 
   unsigned char    GPTCTL2;        // GPT Control Register 2
   unsigned char    GPTIE;          // GPT Interrupt Enable Register
   unsigned char    GPTSCR2;        // GPT System Control Register 2
   unsigned char    GPTFLG1;        // GPT Flag Register 1
   unsigned char    GPTFLG2;        // GPT Flag Register 2
   uint16_t  GPTC0;          // GPT Channel 0 Register
   uint16_t  GPTC1;          // GPT Channel 1 Register
   uint16_t  GPTC2;          // GPT Channel 2 Register
   uint16_t  GPTC3;          // GPT Channel 3 Register
   unsigned char    GPTPACTL;       // Pulse Accumulator Control Register
   unsigned char    GPTPAFLG;       // Pulse Accumulator Flag Register
   uint16_t  GPTPACNT;       // Pulse Accumulator Counter Register
   unsigned char    filler3;
   unsigned char    GPTPORT;        // GPT Port Data Register
   unsigned char    GPTDDR;         // GPT Port Data Direction Register   
   unsigned char    filler[0xFFE0];
} MCF5225_GPT_STRUCT, * MCF5225_GPT_STRUCT_PTR;
typedef volatile struct mcf5225_gpt_struct * VMCF5225_GPT_STRUCT_PTR;
...
{   
   unsigned char    PWME;            // PWM Enable Register
   unsigned char    PWMPOL;          // PWM Polarity Register
   unsigned char    PWMCLK;          // PWM Clock Select Register
   unsigned char    PWMPRCLK;        // PWM Prescale Clock Select Register
   unsigned char    PWMCAE;          // PWM Center Align Enable Register
   unsigned char    PWMCTL;          // PWM Control Register
   unsigned char    filler1[2];
   unsigned char    PWMSCLA;         // PWM Scale A Register
   unsigned char    PWMSCLB;         // PWM Scale B Register
   unsigned char    filler2[2];
   unsigned char    PWMCNT[8];       // PWM Channel Counter Registers (0-7)
   unsigned char    PWMPER[8];       // PWM Channel Period Registers (0-7)
   unsigned char    PWMDTY[8];       // PWM Channel Duty Register (0-7)
   unsigned char    PWMSDN;          // PWM Shutdown Register
   unsigned char    filler[0xFFDB];   
} MCF5225_PWM_STRUCT, * MCF5225_PWM_STRUCT_PTR;
typedef volatile struct mcf5225_pwm_struct * VMCF5225_PWM_STRUCT_PTR;
...
{
   uint32_t  RNGCR;            // Random Number Generator Control Register
   uint32_t  RNGSR;            // Random Number Generator Status Register 1
   uint32_t  RNGER;            // Random Number Generator Entropy Register
   uint32_t  RNGOUT;           // Random Number Generator Output Register
   unsigned char    filler[0xFFEC]; 
} MCF5225_RNG_STRUCT, * MCF5225_RNG_STRUCT_PTR;
typedef volatile struct mcf5225_rng_struct * VMCF5225_RNG_STRUCT_PTR;
...
extern void   *_mcf5225_get_ipsbar(void);
extern void    _mcf5225_initialize_support(uint32_t);

extern void    _mcf5225_cache_enable(uint32_t);
...
extern void    _dcache_flush_invalidate_mlines(void *,uint32_t,uint32_t,uint32_t,uint32_t);

extern void    _mcf5225_mmu_init(uint32_t);
extern uint32_t _mcf5225_mmu_enable(void);
extern uint32_t _mcf5225_mmu_disable(void);
extern uint32_t _mcf5225_mmu_add_region(void *,uint32_t,uint32_t);

extern void    __psp_enable_acrs(uint32_t *);
extern void    __psp_clear_acrs(void);
extern void    __psp_dcache_flush(uint32_t,uint32_t,uint32_t);
