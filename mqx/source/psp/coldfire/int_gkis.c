...
/* uint32_t _psp_saved_vbr = 0; */
extern unsigned char __VECTOR_TABLE_ROM_START[];
volatile uint32_t _psp_saved_vbr = (uint32_t)__VECTOR_TABLE_ROM_START;
