...
/*!
 * \brief This function converts ticks into milliseconds, with normal rounding
 * 
 * \param[in] tick_ptr Ticks to be converted
 * \param[out] overflow_ptr pointer to where the overflow bool is to be written
 *
...
/*!
 * \brief This function converts ticks into milliseconds, with truncate truncating
 * 
 * \param[in] tick_ptr Ticks to be converted
 * \param[out] overflow_ptr pointer to where the overflow bool is to be written
 *
