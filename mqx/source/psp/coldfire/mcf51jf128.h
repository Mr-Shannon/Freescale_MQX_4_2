...
**
**     Reference manual:    MCF51JF128RM Rev. 3, 5/2011
**     Version:             rev. 1.2, 2011-07-14
**
**     Abstract:
...
**     - rev. 1.2 (2011-07-14)
**         Support of GNUC and IAR compilers has been added.
**         TSI - updated CNTRx bit group names.
**
** ###################################################################
*/
 ...
 *
 * This header file implements peripheral memory map for mcf51jf128 processor.
 */
 ...
 *
 * Converts the interrupt vector index to the interrupt vector address.
 */
 ...
 *
 * Resets the watchdog counter. Call periodically to inform that your
