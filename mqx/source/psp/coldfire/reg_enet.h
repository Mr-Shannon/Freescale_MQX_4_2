...
typedef struct  {
  ...
  uint32_t RMON_T_DROP;                            /*!< Count of frames not counted correctly, offset: 0x200 */
  uint32_t RMON_T_PACKETS;                         /*!< RMON Tx packet count, offset: 0x204 */
  uint32_t RMON_T_BC_PKT;                          /*!< RMON Tx Broadcast Packets, offset: 0x208 */
  uint32_t RMON_T_MC_PKT;                          /*!< RMON Tx Multicast Packets, offset: 0x20C */
  uint32_t RMON_T_CRC_ALIGN;                       /*!< RMON Tx Packets w CRC/Align error, offset: 0x210 */
  uint32_t RMON_T_UNDERSIZE;                       /*!< RMON Tx Packets < 64 bytes, good CRC, offset: 0x214 */
  uint32_t RMON_T_OVERSIZE;                        /*!< RMON Tx Packets > MAX_FL bytes, good CRC, offset: 0x218 */
  uint32_t RMON_T_FRAG;                            /*!< RMON Tx Packets < 64 bytes, bad CRC, offset: 0x21C */
  uint32_t RMON_T_JAB;                             /*!< RMON Tx Packets > MAX_FL bytes, bad CRC, offset: 0x220 */
  uint32_t RMON_T_COL;                             /*!< RMON Tx collision count, offset: 0x224 */
  uint32_t RMON_T_P64;                             /*!< RMON Tx 64 byte packets, offset: 0x228 */
  uint32_t RMON_T_P65TO127;                        /*!< RMON Tx 65 to 127 byte packets, offset: 0x22C */
  uint32_t RMON_T_P128TO255;                       /*!< RMON Tx 128 to 255 byte packets, offset: 0x230 */
  uint32_t RMON_T_P256TO511;                       /*!< RMON Tx 256 to 511 byte packets, offset: 0x234 */
  uint32_t RMON_T_P512TO1023;                      /*!< RMON Tx 512 to 1023 byte packets, offset: 0x238 */
  uint32_t RMON_T_P1024TO2047;                     /*!< RMON Tx 1024 to 2047 byte packets, offset: 0x23C */
  uint32_t RMON_T_P_GTE2048;                       /*!< RMON Tx packets w > 2048 bytes, offset: 0x240 */
  uint32_t RMON_T_OCTETS;                          /*!< RMON Tx Octets, offset: 0x244 */
  uint32_t IEEE_T_DROP;                            /*!< Count of frames not counted correctly, offset: 0x248 */
  uint32_t IEEE_T_FRAME_OK;                        /*!< Frames Transmitted OK, offset: 0x24C */
  uint32_t IEEE_T_1COL;                            /*!< Frames Transmitted with Single Collision, offset: 0x250 */
  uint32_t IEEE_T_MCOL;                            /*!< Frames Transmitted with Multiple Collisions, offset: 0x254 */
  uint32_t IEEE_T_DEF;                             /*!< Frames Transmitted after Deferral Delay, offset: 0x258 */
  uint32_t IEEE_T_LCOL;                            /*!< Frames Transmitted with Late Collision, offset: 0x25C */
  uint32_t IEEE_T_EXCOL;                           /*!< Frames Transmitted with Excessive Collisions, offset: 0x260 */
  uint32_t IEEE_T_MACERR;                          /*!< Frames Transmitted with Tx FIFO Underrun, offset: 0x264 */
  uint32_t IEEE_T_CSERR;                           /*!< Frames Transmitted with Carrier Sense Error, offset: 0x268 */
  uint32_t IEEE_T_SQE;                             /*!< Frames Transmitted with SQE Error, offset: 0x26C */
  uint32_t IEEE_T_FDXFC;                           /*!< Flow Control Pause frames transmitted, offset: 0x270 */
  uint32_t IEEE_T_OCTETS_OK;                       /*!< Octet count for Frames Transmitted w/o Error, offset: 0x274 */
  uint8_t RESERVED_14[12];
  uint32_t RMON_R_PACKETS;                         /*!< RMON Rx packet count, offset: 0x284 */
  uint32_t RMON_R_BC_PKT;                          /*!< RMON Rx Broadcast Packets, offset: 0x288 */
  uint32_t RMON_R_MC_PKT;                          /*!< RMON Rx Multicast Packets, offset: 0x28C */
  uint32_t RMON_R_CRC_ALIGN;                       /*!< RMON Rx Packets w CRC/Align error, offset: 0x290 */
  uint32_t RMON_R_UNDERSIZE;                       /*!< RMON Rx Packets < 64 bytes, good CRC, offset: 0x294 */
  uint32_t RMON_R_OVERSIZE;                        /*!< RMON Rx Packets > MAX_FL bytes, good CRC, offset: 0x298 */
  uint32_t RMON_R_FRAG;                            /*!< RMON Rx Packets < 64 bytes, bad CRC, offset: 0x29C */
  uint32_t RMON_R_JAB;                             /*!< RMON Rx Packets > MAX_FL bytes, bad CRC, offset: 0x2A0 */
  uint32_t RMON_R_RESVD_0;                         /*!< Reserved, offset: 0x2A4 */
  uint32_t RMON_R_P64;                             /*!< RMON Rx 64 byte packets, offset: 0x2A8 */
  uint32_t RMON_R_P65TO127;                        /*!< RMON Rx 65 to 127 byte packets, offset: 0x2AC */
  uint32_t RMON_R_P128TO255;                       /*!< RMON Rx 128 to 255 byte packets, offset: 0x2B0 */
  uint32_t RMON_R_P256TO511;                       /*!< RMON Rx 256 to 511 byte packets, offset: 0x2B4 */
  uint32_t RMON_R_P512TO1023;                      /*!< RMON Rx 512 to 1023 byte packets, offset: 0x2B8 */
  uint32_t RMON_R_P1024TO2047;                     /*!< RMON Rx 1024 to 2047 byte packets, offset: 0x2BC */
  uint32_t RMON_R_P_GTE2048;                       /*!< RMON Rx packets w > 2048 bytes, offset: 0x2C0 */
  uint32_t RMON_R_OCTETS;                          /*!< RMON Rx Octets, offset: 0x2C4 */
  uint32_t RMON_R_DROP;                            /*!< Count of frames not counted correctly, offset: 0x2C8 */
  uint32_t RMON_R_FRAME_OK;                        /*!< Frames Received OK, offset: 0x2CC */
  uint32_t IEEE_R_CRC;                             /*!< Frames Received with CRC Error, offset: 0x2D0 */
  uint32_t IEEE_R_ALIGN;                           /*!< Frames Received with Alignment Error, offset: 0x2D4 */
  uint32_t IEEE_R_MACERR;                          /*!< Receive Fifo Overflow count, offset: 0x2D8 */
  uint32_t IEEE_R_FDXFC;                           /*!< Flow Control Pause frames received, offset: 0x2DC */
  uint32_t IEEE_R_OCTETS_OK;                       /*!< Octet count for Frames Rcvd w/o Error, offset: 0x2E0 */
...
#define ENET_RMON_T_DROP_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_DROP_Value_SHIFT))&ENET_RMON_T_DROP_Value_MASK)
/* RMON_T_PACKETS Bit Fields */
#define ENET_RMON_T_PACKETS_Value_MASK           0xFFFFFFFFu
#define ENET_RMON_T_PACKETS_Value_SHIFT          0
#define ENET_RMON_T_PACKETS_Value(x)             (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_PACKETS_Value_SHIFT))&ENET_RMON_T_PACKETS_Value_MASK)
/* RMON_T_BC_PKT Bit Fields */
#define ENET_RMON_T_BC_PKT_Value_MASK            0xFFFFFFFFu
#define ENET_RMON_T_BC_PKT_Value_SHIFT           0
#define ENET_RMON_T_BC_PKT_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_BC_PKT_Value_SHIFT))&ENET_RMON_T_BC_PKT_Value_MASK)
/* RMON_T_MC_PKT Bit Fields */
#define ENET_RMON_T_MC_PKT_Value_MASK            0xFFFFFFFFu
#define ENET_RMON_T_MC_PKT_Value_SHIFT           0
#define ENET_RMON_T_MC_PKT_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_MC_PKT_Value_SHIFT))&ENET_RMON_T_MC_PKT_Value_MASK)
/* RMON_T_CRC_ALIGN Bit Fields */
#define ENET_RMON_T_CRC_ALIGN_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_T_CRC_ALIGN_Value_SHIFT        0
#define ENET_RMON_T_CRC_ALIGN_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_CRC_ALIGN_Value_SHIFT))&ENET_RMON_T_CRC_ALIGN_Value_MASK)
/* RMON_T_UNDERSIZE Bit Fields */
#define ENET_RMON_T_UNDERSIZE_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_T_UNDERSIZE_Value_SHIFT        0
#define ENET_RMON_T_UNDERSIZE_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_UNDERSIZE_Value_SHIFT))&ENET_RMON_T_UNDERSIZE_Value_MASK)
/* RMON_T_OVERSIZE Bit Fields */
#define ENET_RMON_T_OVERSIZE_Value_MASK          0xFFFFFFFFu
#define ENET_RMON_T_OVERSIZE_Value_SHIFT         0
#define ENET_RMON_T_OVERSIZE_Value(x)            (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_OVERSIZE_Value_SHIFT))&ENET_RMON_T_OVERSIZE_Value_MASK)
/* RMON_T_FRAG Bit Fields */
#define ENET_RMON_T_FRAG_Value_MASK              0xFFFFFFFFu
#define ENET_RMON_T_FRAG_Value_SHIFT             0
#define ENET_RMON_T_FRAG_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_FRAG_Value_SHIFT))&ENET_RMON_T_FRAG_Value_MASK)
/* RMON_T_JAB Bit Fields */
#define ENET_RMON_T_JAB_Value_MASK               0xFFFFFFFFu
#define ENET_RMON_T_JAB_Value_SHIFT              0
#define ENET_RMON_T_JAB_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_JAB_Value_SHIFT))&ENET_RMON_T_JAB_Value_MASK)
/* RMON_T_COL Bit Fields */
#define ENET_RMON_T_COL_Value_MASK               0xFFFFFFFFu
#define ENET_RMON_T_COL_Value_SHIFT              0
#define ENET_RMON_T_COL_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_COL_Value_SHIFT))&ENET_RMON_T_COL_Value_MASK)
/* RMON_T_P64 Bit Fields */
#define ENET_RMON_T_P64_Value_MASK               0xFFFFFFFFu
#define ENET_RMON_T_P64_Value_SHIFT              0
#define ENET_RMON_T_P64_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P64_Value_SHIFT))&ENET_RMON_T_P64_Value_MASK)
/* RMON_T_P65TO127 Bit Fields */
#define ENET_RMON_T_P65TO127_Value_MASK          0xFFFFFFFFu
#define ENET_RMON_T_P65TO127_Value_SHIFT         0
#define ENET_RMON_T_P65TO127_Value(x)            (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P65TO127_Value_SHIFT))&ENET_RMON_T_P65TO127_Value_MASK)
/* RMON_T_P128TO255 Bit Fields */
#define ENET_RMON_T_P128TO255_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_T_P128TO255_Value_SHIFT        0
#define ENET_RMON_T_P128TO255_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P128TO255_Value_SHIFT))&ENET_RMON_T_P128TO255_Value_MASK)
/* RMON_T_P256TO511 Bit Fields */
#define ENET_RMON_T_P256TO511_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_T_P256TO511_Value_SHIFT        0
#define ENET_RMON_T_P256TO511_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P256TO511_Value_SHIFT))&ENET_RMON_T_P256TO511_Value_MASK)
...
#define ENET_RMON_T_P512TO1023_Value(x)          (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P512TO1023_Value_SHIFT))&ENET_RMON_T_P512TO1023_Value_MASK)
...
#define ENET_RMON_T_P1024TO2047_Value(x)         (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P1024TO2047_Value_SHIFT))&ENET_RMON_T_P1024TO2047_Value_MASK)
/* RMON_T_P_GTE2048 Bit Fields */
#define ENET_RMON_T_P_GTE2048_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_T_P_GTE2048_Value_SHIFT        0
#define ENET_RMON_T_P_GTE2048_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_P_GTE2048_Value_SHIFT))&ENET_RMON_T_P_GTE2048_Value_MASK)
/* RMON_T_OCTETS Bit Fields */
#define ENET_RMON_T_OCTETS_Value_MASK            0xFFFFFFFFu
#define ENET_RMON_T_OCTETS_Value_SHIFT           0
#define ENET_RMON_T_OCTETS_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_RMON_T_OCTETS_Value_SHIFT))&ENET_RMON_T_OCTETS_Value_MASK)
/* IEEE_T_DROP Bit Fields */
#define ENET_IEEE_T_DROP_Value_MASK              0xFFFFFFFFu
#define ENET_IEEE_T_DROP_Value_SHIFT             0
#define ENET_IEEE_T_DROP_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_DROP_Value_SHIFT))&ENET_IEEE_T_DROP_Value_MASK)
/* IEEE_T_FRAME_OK Bit Fields */
#define ENET_IEEE_T_FRAME_OK_Value_MASK          0xFFFFFFFFu
#define ENET_IEEE_T_FRAME_OK_Value_SHIFT         0
#define ENET_IEEE_T_FRAME_OK_Value(x)            (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_FRAME_OK_Value_SHIFT))&ENET_IEEE_T_FRAME_OK_Value_MASK)
/* IEEE_T_1COL Bit Fields */
#define ENET_IEEE_T_1COL_Value_MASK              0xFFFFFFFFu
#define ENET_IEEE_T_1COL_Value_SHIFT             0
#define ENET_IEEE_T_1COL_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_1COL_Value_SHIFT))&ENET_IEEE_T_1COL_Value_MASK)
/* IEEE_T_MCOL Bit Fields */
#define ENET_IEEE_T_MCOL_Value_MASK              0xFFFFFFFFu
#define ENET_IEEE_T_MCOL_Value_SHIFT             0
#define ENET_IEEE_T_MCOL_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_MCOL_Value_SHIFT))&ENET_IEEE_T_MCOL_Value_MASK)
/* IEEE_T_DEF Bit Fields */
#define ENET_IEEE_T_DEF_Value_MASK               0xFFFFFFFFu
#define ENET_IEEE_T_DEF_Value_SHIFT              0
#define ENET_IEEE_T_DEF_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_DEF_Value_SHIFT))&ENET_IEEE_T_DEF_Value_MASK)
/* IEEE_T_LCOL Bit Fields */
#define ENET_IEEE_T_LCOL_Value_MASK              0xFFFFFFFFu
#define ENET_IEEE_T_LCOL_Value_SHIFT             0
#define ENET_IEEE_T_LCOL_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_LCOL_Value_SHIFT))&ENET_IEEE_T_LCOL_Value_MASK)
/* IEEE_T_EXCOL Bit Fields */
#define ENET_IEEE_T_EXCOL_Value_MASK             0xFFFFFFFFu
#define ENET_IEEE_T_EXCOL_Value_SHIFT            0
#define ENET_IEEE_T_EXCOL_Value(x)               (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_EXCOL_Value_SHIFT))&ENET_IEEE_T_EXCOL_Value_MASK)
/* IEEE_T_MACERR Bit Fields */
#define ENET_IEEE_T_MACERR_Value_MASK            0xFFFFFFFFu
#define ENET_IEEE_T_MACERR_Value_SHIFT           0
#define ENET_IEEE_T_MACERR_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_MACERR_Value_SHIFT))&ENET_IEEE_T_MACERR_Value_MASK)
/* IEEE_T_CSERR Bit Fields */
#define ENET_IEEE_T_CSERR_Value_MASK             0xFFFFFFFFu
#define ENET_IEEE_T_CSERR_Value_SHIFT            0
#define ENET_IEEE_T_CSERR_Value(x)               (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_CSERR_Value_SHIFT))&ENET_IEEE_T_CSERR_Value_MASK)
/* IEEE_T_SQE Bit Fields */
#define ENET_IEEE_T_SQE_Value_MASK               0xFFFFFFFFu
#define ENET_IEEE_T_SQE_Value_SHIFT              0
#define ENET_IEEE_T_SQE_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_SQE_Value_SHIFT))&ENET_IEEE_T_SQE_Value_MASK)
/* IEEE_T_FDXFC Bit Fields */
#define ENET_IEEE_T_FDXFC_Value_MASK             0xFFFFFFFFu
#define ENET_IEEE_T_FDXFC_Value_SHIFT            0
#define ENET_IEEE_T_FDXFC_Value(x)               (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_FDXFC_Value_SHIFT))&ENET_IEEE_T_FDXFC_Value_MASK)
/* IEEE_T_OCTETS_OK Bit Fields */
#define ENET_IEEE_T_OCTETS_OK_Value_MASK         0xFFFFFFFFu
#define ENET_IEEE_T_OCTETS_OK_Value_SHIFT        0
#define ENET_IEEE_T_OCTETS_OK_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_T_OCTETS_OK_Value_SHIFT))&ENET_IEEE_T_OCTETS_OK_Value_MASK)
/* RMON_R_PACKETS Bit Fields */
#define ENET_RMON_R_PACKETS_Value_MASK           0xFFFFFFFFu
#define ENET_RMON_R_PACKETS_Value_SHIFT          0
#define ENET_RMON_R_PACKETS_Value(x)             (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_PACKETS_Value_SHIFT))&ENET_RMON_R_PACKETS_Value_MASK)
/* RMON_R_BC_PKT Bit Fields */
#define ENET_RMON_R_BC_PKT_Value_MASK            0xFFFFFFFFu
#define ENET_RMON_R_BC_PKT_Value_SHIFT           0
#define ENET_RMON_R_BC_PKT_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_BC_PKT_Value_SHIFT))&ENET_RMON_R_BC_PKT_Value_MASK)
/* RMON_R_MC_PKT Bit Fields */
#define ENET_RMON_R_MC_PKT_Value_MASK            0xFFFFFFFFu
#define ENET_RMON_R_MC_PKT_Value_SHIFT           0
#define ENET_RMON_R_MC_PKT_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_MC_PKT_Value_SHIFT))&ENET_RMON_R_MC_PKT_Value_MASK)
/* RMON_R_CRC_ALIGN Bit Fields */
#define ENET_RMON_R_CRC_ALIGN_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_R_CRC_ALIGN_Value_SHIFT        0
#define ENET_RMON_R_CRC_ALIGN_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_CRC_ALIGN_Value_SHIFT))&ENET_RMON_R_CRC_ALIGN_Value_MASK)
/* RMON_R_UNDERSIZE Bit Fields */
#define ENET_RMON_R_UNDERSIZE_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_R_UNDERSIZE_Value_SHIFT        0
#define ENET_RMON_R_UNDERSIZE_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_UNDERSIZE_Value_SHIFT))&ENET_RMON_R_UNDERSIZE_Value_MASK)
/* RMON_R_OVERSIZE Bit Fields */
#define ENET_RMON_R_OVERSIZE_Value_MASK          0xFFFFFFFFu
#define ENET_RMON_R_OVERSIZE_Value_SHIFT         0
#define ENET_RMON_R_OVERSIZE_Value(x)            (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_OVERSIZE_Value_SHIFT))&ENET_RMON_R_OVERSIZE_Value_MASK)
/* RMON_R_FRAG Bit Fields */
#define ENET_RMON_R_FRAG_Value_MASK              0xFFFFFFFFu
#define ENET_RMON_R_FRAG_Value_SHIFT             0
#define ENET_RMON_R_FRAG_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_FRAG_Value_SHIFT))&ENET_RMON_R_FRAG_Value_MASK)
/* RMON_R_JAB Bit Fields */
#define ENET_RMON_R_JAB_Value_MASK               0xFFFFFFFFu
#define ENET_RMON_R_JAB_Value_SHIFT              0
#define ENET_RMON_R_JAB_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_JAB_Value_SHIFT))&ENET_RMON_R_JAB_Value_MASK)
/* RMON_R_RESVD_0 Bit Fields */
#define ENET_RMON_R_RESVD_0_Value_MASK           0xFFFFFFFFu
#define ENET_RMON_R_RESVD_0_Value_SHIFT          0
#define ENET_RMON_R_RESVD_0_Value(x)             (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_RESVD_0_Value_SHIFT))&ENET_RMON_R_RESVD_0_Value_MASK)
/* RMON_R_P64 Bit Fields */
#define ENET_RMON_R_P64_Value_MASK               0xFFFFFFFFu
#define ENET_RMON_R_P64_Value_SHIFT              0
#define ENET_RMON_R_P64_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P64_Value_SHIFT))&ENET_RMON_R_P64_Value_MASK)
/* RMON_R_P65TO127 Bit Fields */
#define ENET_RMON_R_P65TO127_Value_MASK          0xFFFFFFFFu
#define ENET_RMON_R_P65TO127_Value_SHIFT         0
#define ENET_RMON_R_P65TO127_Value(x)            (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P65TO127_Value_SHIFT))&ENET_RMON_R_P65TO127_Value_MASK)
/* RMON_R_P128TO255 Bit Fields */
#define ENET_RMON_R_P128TO255_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_R_P128TO255_Value_SHIFT        0
#define ENET_RMON_R_P128TO255_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P128TO255_Value_SHIFT))&ENET_RMON_R_P128TO255_Value_MASK)
/* RMON_R_P256TO511 Bit Fields */
#define ENET_RMON_R_P256TO511_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_R_P256TO511_Value_SHIFT        0
#define ENET_RMON_R_P256TO511_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P256TO511_Value_SHIFT))&ENET_RMON_R_P256TO511_Value_MASK)
...
#define ENET_RMON_R_P512TO1023_Value(x)          (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P512TO1023_Value_SHIFT))&ENET_RMON_R_P512TO1023_Value_MASK)
...
#define ENET_RMON_R_P1024TO2047_Value(x)         (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P1024TO2047_Value_SHIFT))&ENET_RMON_R_P1024TO2047_Value_MASK)
/* RMON_R_P_GTE2048 Bit Fields */
#define ENET_RMON_R_P_GTE2048_Value_MASK         0xFFFFFFFFu
#define ENET_RMON_R_P_GTE2048_Value_SHIFT        0
#define ENET_RMON_R_P_GTE2048_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_P_GTE2048_Value_SHIFT))&ENET_RMON_R_P_GTE2048_Value_MASK)
/* RMON_R_OCTETS Bit Fields */
#define ENET_RMON_R_OCTETS_Value_MASK            0xFFFFFFFFu
#define ENET_RMON_R_OCTETS_Value_SHIFT           0
#define ENET_RMON_R_OCTETS_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_OCTETS_Value_SHIFT))&ENET_RMON_R_OCTETS_Value_MASK)
/* RMON_R_DROP Bit Fields */
#define ENET_RMON_R_DROP_Value_MASK              0xFFFFFFFFu
#define ENET_RMON_R_DROP_Value_SHIFT             0
#define ENET_RMON_R_DROP_Value(x)                (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_DROP_Value_SHIFT))&ENET_RMON_R_DROP_Value_MASK)
/* RMON_R_FRAME_OK Bit Fields */
#define ENET_RMON_R_FRAME_OK_Value_MASK          0xFFFFFFFFu
#define ENET_RMON_R_FRAME_OK_Value_SHIFT         0
#define ENET_RMON_R_FRAME_OK_Value(x)            (((uint32_t)(((uint32_t)(x))<<ENET_RMON_R_FRAME_OK_Value_SHIFT))&ENET_RMON_R_FRAME_OK_Value_MASK)
/* IEEE_R_CRC Bit Fields */
#define ENET_IEEE_R_CRC_Value_MASK               0xFFFFFFFFu
#define ENET_IEEE_R_CRC_Value_SHIFT              0
#define ENET_IEEE_R_CRC_Value(x)                 (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_R_CRC_Value_SHIFT))&ENET_IEEE_R_CRC_Value_MASK)
/* IEEE_R_ALIGN Bit Fields */
#define ENET_IEEE_R_ALIGN_Value_MASK             0xFFFFFFFFu
#define ENET_IEEE_R_ALIGN_Value_SHIFT            0
#define ENET_IEEE_R_ALIGN_Value(x)               (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_R_ALIGN_Value_SHIFT))&ENET_IEEE_R_ALIGN_Value_MASK)
/* IEEE_R_MACERR Bit Fields */
#define ENET_IEEE_R_MACERR_Value_MASK            0xFFFFFFFFu
#define ENET_IEEE_R_MACERR_Value_SHIFT           0
#define ENET_IEEE_R_MACERR_Value(x)              (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_R_MACERR_Value_SHIFT))&ENET_IEEE_R_MACERR_Value_MASK)
/* IEEE_R_FDXFC Bit Fields */
#define ENET_IEEE_R_FDXFC_Value_MASK             0xFFFFFFFFu
#define ENET_IEEE_R_FDXFC_Value_SHIFT            0
#define ENET_IEEE_R_FDXFC_Value(x)               (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_R_FDXFC_Value_SHIFT))&ENET_IEEE_R_FDXFC_Value_MASK)
/* IEEE_R_OCTETS_OK Bit Fields */
#define ENET_IEEE_R_OCTETS_OK_Value_MASK         0xFFFFFFFFu
#define ENET_IEEE_R_OCTETS_OK_Value_SHIFT        0
#define ENET_IEEE_R_OCTETS_OK_Value(x)           (((uint32_t)(((uint32_t)(x))<<ENET_IEEE_R_OCTETS_OK_Value_SHIFT))&ENET_IEEE_R_OCTETS_OK_Value_MASK)
/* ATCR Bit Fields */
