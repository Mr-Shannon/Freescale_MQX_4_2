...
#define _software_interrupt_invoke(num)                 _gic_swint_invoke(num)
...
#define BSP_SOFTWARE_INTERRUPT_VECTOR              (INT_Reserved44) // Using INT_Reserved44 temporarily because INT_SGIs does not work
