...
*   Freescale TWR-VF522REVB Evaluation board.
*
*
*END************************************************************************/

#ifndef _svf522revb_a5_
#define _svf522revb_a5_  1
...
*/
#define BSP_SVF522REVB_A5               	1
#define BSP_NAME                            "SVF522REVB_A5"
...
/* Define the PLL5 main Clock for ENET module*/
#define BSP_PLL5_ENET_CLOCK                (50000000u)
...
#define BSP_TIMER_INTERRUPT_VECTOR GIC_GlobalTimer
...
//#define BSP_INTERRUPT_VECTOR_TABLE ...
   ...
   #define BSP_FIRST_INTERRUPT_VECTOR_USED  A5_Reset
#endif

#ifndef BSP_LAST_INTERRUPT_VECTOR_USED
   #define BSP_LAST_INTERRUPT_VECTOR_USED   GIC_GPIO4
#endif
...
/*-----------------------------------------------------------------------------
**						Serial Flash memory sst25vf032b
*/
#define BSP_SPI_MEMORY_SST25VF032B 			1
...
**                      GPIO
** NOTE:
** Button4 (SW6) is shared with SAI0_RX_SYNC. Uncomment BUTTON4 in case
...
/*
 * correct accroding to SCH
 */
#define BSP_SW4                             (LWGPIO_PIN_PTD31)
#define BSP_SW4_MUX_GPIO                    (LWGPIO_MUX_PTD31_GPIO)

#define BSP_SW5                             (LWGPIO_PIN_PTD29)
#define BSP_SW5_MUX_GPIO                    (LWGPIO_MUX_PTD29_GPIO)

#define BSP_SW3                             (LWGPIO_PIN_PTB27)
#define BSP_SW3_MUX_GPIO                    (LWGPIO_MUX_PTB27_GPIO)

#define BSP_SW6                             (LWGPIO_PIN_PTD30)
#define BSP_SW6_MUX_GPIO                    (LWGPIO_MUX_PTD30_GPIO)

#define BSP_BUTTON1                         BSP_SW4
#define BSP_BUTTON1_MUX_GPIO                BSP_SW4_MUX_GPIO
#define BSP_BUTTON1_MUX_IRQ                 BSP_SW4_MUX_GPIO

#define BSP_BUTTON2                         BSP_SW5
#define BSP_BUTTON2_MUX_GPIO                BSP_SW5_MUX_GPIO
#define BSP_BUTTON2_MUX_IRQ                 BSP_SW5_MUX_GPIO

#define BSP_BUTTON3                         BSP_SW6
#define BSP_BUTTON3_MUX_GPIO                BSP_SW6_MUX_GPIO
#define BSP_BUTTON3_MUX_IRQ                 BSP_SW6_MUX_GPIO

/*
 * Button4 will be used as wakeup interrupt
 */
#define BSP_BUTTON4                         BSP_SW3
#define BSP_BUTTON4_MUX_GPIO                BSP_SW3_MUX_GPIO
#define BSP_BUTTON4_MUX_IRQ                 BSP_SW3_MUX_GPIO
...
#define VF522REVB_SRAM_BASE                  (0x3f000000)
#define VF522REVB_SRAM_CORE_0_BASE           (0x3f07f000)
#define VF522REVB_SRAM_CORE_0_SIZE           (2 * 1024)
#define VF522REVB_SRAM_CORE_0_END            (VF522REVB_SRAM_CORE_0_BASE + VF522REVB_SRAM_CORE_0_SIZE)

#define VF522REVB_SRAM_CORE_1_BASE           (0x3f07f800)
#define VF522REVB_SRAM_CORE_1_SIZE           (2 * 1024)
#define VF522REVB_SRAM_CORE_1_END            (VF522REVB_SRAM_CORE_1_BASE + VF522REVB_SRAM_CORE_1_SIZE)
...
#endif
#define BSP_REMOTE_SHARED_RAM_START         (VF522REVB_SRAM_CORE_1_BASE)
