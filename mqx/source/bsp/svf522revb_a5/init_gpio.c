   ...
   switch (dev_num)
    {
        case 0:
            IOMUXC_RGPIO(99) = 
                ...
                IOMUXC_SW_MUX_CTL_PAD_PAD_MUX_MODE(2); //PTC26.CS5
    ...
    switch (dev_num)
    {
        case 0:
            ...
            IOMUXC_RGPIO(37) =
                ...
                IOMUXC_SW_MUX_CTL_PAD_PAD_PUS(2) |
                IOMUXC_SW_MUX_CTL_PAD_PAD_DSE(7) |
                IOMUXC_SW_MUX_CTL_PAD_PAD_HYS(1) |
                IOMUXC_SW_MUX_CTL_PAD_PAD_SPEED(2) |
                IOMUXC_SW_MUX_CTL_PAD_PAD_MUX_MODE(1);
    ...
    switch (dev_num)
    {
        ...
        case 2:
            ...
            IOMUXC_I2C2_IPP_SCL_IND_SELECT_INPUT = \
              (((uint32_t)(((uint32_t)(1))<<IOMUXC_I2C2_IPP_SCL_IND_SELECT_INPUT_DAISY_SHIFT))\
              &IOMUXC_I2C2_IPP_SCL_IND_SELECT_INPUT_DAISY_MASK);   // ALT3 - PAD_12
            
            IOMUXC_I2C2_IPP_SDA_IND_SELECT_INPUT = \
              (((uint32_t)(((uint32_t)(1))<<IOMUXC_I2C2_IPP_SDA_IND_SELECT_INPUT_DAISY_SHIFT))\
              &IOMUXC_I2C2_IPP_SDA_IND_SELECT_INPUT_DAISY_MASK);   // ALT3 - PAD_13
            status = MQX_OK;
        break;
        case 3:
