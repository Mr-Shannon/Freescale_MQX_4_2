    ...
    switch (pll_num) {
        case CM_CLOCK_PLL1:
            ...
            if (pfd_num == CM_CLOCK_PLL_main)
                ...
                pfd_frac = (anadig->PLL1_PFD & ANADIG_PLL1_PFD_PFD1_FRAC_MASK) >> ANADIG_PLL1_PFD_PFD1_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD2)
                pfd_frac = (anadig->PLL1_PFD & ANADIG_PLL1_PFD_PFD2_FRAC_MASK) >> ANADIG_PLL1_PFD_PFD2_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD3)
                pfd_frac = (anadig->PLL1_PFD & ANADIG_PLL1_PFD_PFD3_FRAC_MASK) >> ANADIG_PLL1_PFD_PFD3_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD4)
                pfd_frac = (anadig->PLL1_PFD & ANADIG_PLL1_PFD_PFD4_FRAC_MASK) >> ANADIG_PLL1_PFD_PFD4_FRAC_SHIFT;
            else {
        ...
        case CM_CLOCK_PLL2:
            ...
            if (pfd_num == CM_CLOCK_PLL_main)
                ...
                pfd_frac = (anadig->PLL2_PFD & ANADIG_PLL2_PFD_PFD1_FRAC_MASK) >> ANADIG_PLL2_PFD_PFD1_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD2)
                pfd_frac = (anadig->PLL2_PFD & ANADIG_PLL2_PFD_PFD2_FRAC_MASK) >> ANADIG_PLL2_PFD_PFD2_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD3)
                pfd_frac = (anadig->PLL2_PFD & ANADIG_PLL2_PFD_PFD3_FRAC_MASK) >> ANADIG_PLL2_PFD_PFD3_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD4)
                pfd_frac = (anadig->PLL2_PFD & ANADIG_PLL2_PFD_PFD4_FRAC_MASK) >> ANADIG_PLL2_PFD_PFD4_FRAC_SHIFT;
            else {
        ...
        case CM_CLOCK_PLL3:
            ...
            if (pfd_num == CM_CLOCK_PLL_main)
                ...
                pfd_frac = (anadig->PLL3_PFD & ANADIG_PLL3_PFD_PFD1_FRAC_MASK) >> ANADIG_PLL3_PFD_PFD1_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD2)
                pfd_frac = (anadig->PLL3_PFD & ANADIG_PLL3_PFD_PFD2_FRAC_MASK) >> ANADIG_PLL3_PFD_PFD2_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD3)
                pfd_frac = (anadig->PLL3_PFD & ANADIG_PLL3_PFD_PFD3_FRAC_MASK) >> ANADIG_PLL3_PFD_PFD3_FRAC_SHIFT;
            else if (pfd_num == CM_CLOCK_PLL_PFD4)
                pfd_frac = (anadig->PLL3_PFD & ANADIG_PLL3_PFD_PFD4_FRAC_MASK) >> ANADIG_PLL3_PFD_PFD4_FRAC_SHIFT;
            else {
                printf("Error: PLL2 PFD%d is not supported by %s\n", pfd_num, __func__);
                return 0;
            }
