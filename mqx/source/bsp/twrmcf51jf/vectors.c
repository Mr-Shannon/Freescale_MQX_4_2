...
/* CFM init */
#define CFMDFPROT 0xFF
#define CFMEEPROT 0xFF
...
#define CFMSEC    0x02
    ...
    const unsigned char _cfm[16] @ "CFMCONFIG" = {
        0,0,0,0,0,0,0,0, /* NVBACKKEY */
        0,0,0,0,   /* Flash protection */
        CFMDFPROT, /* Data flash protection */
        CFMEEPROT, /* EEPROM protection */
        CFMNVOPT,  /* Option Byte */
        CFMSEC     /* Security Byte */
    };
