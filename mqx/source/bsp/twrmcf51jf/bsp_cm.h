...
*
* Comments:
*   Clock manager CF+ BSP specific definitions and function prototypes.
*
...
#define CPU_CORE_CLK_HZ_CLOCK_CONFIG1   16000000U /* Value of the core/system clock frequency in the clock configuration 1 in Hz. */

#define CPU_BUS_CLK_HZ_CLOCK_CONFIG2    1000000U /* Value of the bus clock frequency in the clock configuration 2 in Hz. */
...
#define CPU_FAMILY_ColdFirePlus        /* Specification of the core type of the selected cpu */
#define CPU_DERIVATIVE_MCF51JF128_64   /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MCF51JF128VLH      /* Part number of the selected cpu */
#define CPU_BIG_ENDIAN                 /* The selected cpu uses big endian */
...
#define CPU_CORE_CLK_HZ_CONFIG_1        16000000UL /* Core clock frequency in clock configuration 1 */
...
#define CPU_ERCLK32K_CLK_HZ_CONFIG_1    0UL /* External reference clock 32k frequency in clock configuration 1 */
...
#define CPU_BUS_CLK_HZ_CONFIG_2         1000000UL /* Bus clock frequency in clock configuration 2 */
...
typedef enum {
    BSP_CLOCK_CONFIGURATION_0 = 0,      /* Core clock = 48 MHZ PEE mode  */
    BSP_CLOCK_CONFIGURATION_1,          /* Core clock = 16 MHz PEE mode  */
    BSP_CLOCK_CONFIGURATION_2,          /* Core clock =  2 MHz BLPI mode */
    ...
    BSP_CLOCK_CONFIGURATION_16MHZ       = BSP_CLOCK_CONFIGURATION_1,
