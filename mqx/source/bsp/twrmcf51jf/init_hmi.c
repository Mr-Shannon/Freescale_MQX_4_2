...
/* System control */
static const HMI_TSS_SYSTEM_CONTROL_STRUCT hmi_system_control_coldfire_jf=
{
...
static const HMI_LWGPIO_INIT_STRUCT hmi_init_table_lwgpio[]=
{
    ...
    {HMI_BUTTON_1, BSP_SW1, BSP_BUTTON1_MUX_IRQ, HMI_LWGPIO_FLAG_DIRECTION_IN|HMI_LWGPIO_FLAG_ACTIVE_STATE_0|HMI_LWGPIO_FLAG_PULL_UP_ON},    /* BUTTON 1 */
    {0,0,0},
};
...
{
    _int_install_isr(Vtsi0, TSS_TSI0Isr, NULL);
    _bsp_int_enable(Vtsi0);
    
    _bsp_tss_io_init();                                /* TSI init */
    hmi_tss_init(hmi_system_control_coldfire_jf);      /* TSS init */
