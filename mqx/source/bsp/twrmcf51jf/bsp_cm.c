...
/*
** ===================================================================
**     Method      :  Cpu_MCGAutoTrim (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_VLPModeDisable (component MCF51JF128_64)
**
**     Description :
...
LDD_TError Cpu_VLPModeDisable(void)
{
  ...
  if (SMC_PMSTAT == 0x04U) {           /* Test if in VLPR mode */
    ...
    SMC_PMCTRL = (uint8_t)0x00U;       /* Disable very low power mode */
...
/*
** ===================================================================
**     Method      :  Cpu_VLPModeEnable (component MCF51JF128_64)
**
**     Description :
...
LDD_TError Cpu_VLPModeEnable(void)
{
  ...
  SMC_PMCTRL = (uint8_t)0x40U;         /* Enable very low power mode */
...
/*
** ===================================================================
**     Method      :  Cpu_GetLLSWakeUpFlags (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModePEE (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModePBE (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModeFBE (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModeBLPI (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModeFBI (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCG (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_GetCurrentMCGMode (component MCF51JF128_64)
**
**     Description :
...
static void Cpu_SetMCGModePEE(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 0U:
      /* Switch to PEE Mode */
      /* OSC2_CR: ERCLKEN=1,??=0,EREFSTEN=0,??=0,SC2P=1,SC4P=0,SC8P=0,SC16P=1 */
      OSC2_CR = (uint8_t)0x89U;
...
static void Cpu_SetMCGModePBE(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 0U:
      ...
      while((MCG_S & MCG_S_PLLST_MASK) == 0x00U) { /* Wait until source of PLLS clock is PLL clock */
      }
      while((MCG_S & MCG_S_LOCK_MASK) == 0x00U) { /* Wait until locked */
      }
      break;
    case 1U:
      /* Switch to PBE Mode */
      /* OSC2_CR: ERCLKEN=0,??=0,EREFSTEN=0,??=0,SC2P=1,SC4P=0,SC8P=0,SC16P=1 */
      OSC2_CR = (uint8_t)0x09U;
...
static void Cpu_SetMCGModeFBE(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 0U:
      ...
      while((MCG_S & MCG_S_PLLST_MASK) != 0x00U) { /* Wait until source of PLLS clock is FLL clock */
      }
      break;
    case 1U:
      /* Switch to FBE Mode */
...
/*
** ===================================================================
**     Method      :  Cpu_SetClockConfiguration (component MCF51JF128_64)
**
**     Description :
  ...
  switch (ModeID) {
    case CPU_CLOCK_CONFIG_0:
      if (ClockConfigurationID == 2U) {
        ...
        SIM_CLKDIV0 = (uint8_t)0x01U;  /* Set the system prescaler to safe value */
      ...
      /* SIM_CLKDIV1: USBDIV=1,USBFRAC=0,??=0,??=0,USBSRC=0 */
      SIM_CLKDIV1 = (uint8_t)0x20U;    /* Update USB clock prescalers */
      break;
    case CPU_CLOCK_CONFIG_1:
      if (ClockConfigurationID == 2U) {
      ...
      /* SIM_CLKDIV0: ??=0,??=0,??=0,??=0,OUTDIV=5 */
      SIM_CLKDIV0 = (uint8_t)0x05U;    /* Update system prescaler */
      /* SIM_CLKDIV1: USBDIV=1,USBFRAC=0,??=0,??=0,USBSRC=0 */
      SIM_CLKDIV1 = (uint8_t)0x20U;    /* Update USB clock prescalers */
      break;
    case CPU_CLOCK_CONFIG_2:
      ...
      /* SIM_CLKDIV1: USBDIV=0,USBFRAC=0,??=0,??=0,USBSRC=0 */
      SIM_CLKDIV1 = (uint8_t)0x00U;    /* Update USB clock prescalers */
      break;
    default:
      break;
  }
...
/*
** ===================================================================
**     Method      :  Cpu_GetClockConfiguration (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetOperationMode (component MCF51JF128_64)
**
**     Description :
...
LDD_TError Cpu_SetOperationMode(LDD_TDriverOperationMode OperationMode, LDD_TCallback ModeChangeCallback, LDD_TCallbackParam *ModeChangeCallbackParamPtr)
{
  ...
  switch (OperationMode) {
    case DOM_RUN:
      ...
      break;
    case DOM_WAIT:
      /* SIM_SOPT4: STOPE=1,WAITE=1 */
      SIM_SOPT4 |= (uint8_t)0x30U;
      PE_STOP();
      break;
    case DOM_SLEEP:
      /* SIM_SOPT4: STOPE=1 */
      SIM_SOPT4 |= (uint8_t)0x20U;
      /* SIM_SOPT4: WAITE=0 */
      SIM_SOPT4 &= (uint8_t)~(uint8_t)0x10U;
      /* SMC_PMCTRL: STOPM=0 */
...
/*
** ===================================================================
**     Method      :  Cpu_EnableInt (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_DisableInt (component MCF51JF128_64)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  __pe_initialize_hardware (component MCF51JF128_64)
**
**     Description :
...
void __pe_initialize_hardware(void)
{
  ...
  SIM_CLKDIV1 = (uint8_t)0x20U;        /* Update USB clock prescalers */
  /* SIM_SCGC5: OSC2=1 */
  SIM_SCGC5 |= (uint8_t)0x04U;
  /* SIM_SCGC5: MCG=1 */
  SIM_SCGC5 |= (uint8_t)0x01U;
  /* MXC_PTBPF1: B6=0 */
  MXC_PTBPF1 &= (uint8_t)~(uint8_t)0x0FU;
  /* MXC_PTBPF2: B5=0 */
  MXC_PTBPF2 &= (uint8_t)~(uint8_t)0xF0U;
  /* Switch to FBE Mode */
  /* OSC2_CR: ERCLKEN=1,??=0,EREFSTEN=0,??=0,SC2P=1,SC4P=0,SC8P=0,SC16P=1 */
  OSC2_CR = (uint8_t)0x89U;
  /* MCG_C2: ??=0,??=0,RANGE=2,HGO=1,EREFS=1,LP=0,IRCS=1 */
  ...
  MCG_C6 |= (uint8_t)0x20U;            /* Enable the clock monitor */
  /* MCG_C6: LOLIE=1 */
  MCG_C6 |= (uint8_t)0x80U;            /* Enable the loss of lock interrupt */
...
void PE_low_level_init(void)
{
  ...
  /* LLWU_PE1: WUPE3=0,WUPE2=0,WUPE1=0,WUPE0=3 */
  LLWU_PE1 = (uint8_t)0x03U;
  ...
  /* LLWU_ME: WUME3=0,WUME2=0,WUME1=0,WUME0=1 */
  LLWU_ME = (uint8_t)((LLWU_ME & (uint8_t)~(uint8_t)0x0EU) | (uint8_t)0x01U);
  ...
  /* LLWU_RST: ??=0,??=0,??=0,??=0,??=0,??=0,LLRSTE=1,RSTFILT=1 */
  LLWU_RST = (uint8_t)0x03U;
  ...
  /* INTC_IMRL: IMR2=0,IMR1=1 */
  INTC_IMRL = (uint32_t)((INTC_IMRL & (uint32_t)~0x04UL) | (uint32_t)0x02UL);

  SIM_SOPT4 = SIM_SOPT4_WAITE_MASK | SIM_SOPT4_STOPE_MASK;
...
)
{
    ...
    timer_clock = _bsp_get_clock(clock_configuration, CM_CLOCK_SOURCE_BUS);

    /* Reconfigure system timer for new clock */
    _mtim16_timer_init(BSP_TIMER, BSP_ALARM_FREQUENCY, timer_clock, TRUE);
