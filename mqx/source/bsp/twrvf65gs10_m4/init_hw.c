...
#define PLL_LOCKS (\
        ANADIG_PLL_LOCK_PLL1_MASK       | \
        ANADIG_PLL_LOCK_PLL2_MASK       | \
        ANADIG_PLL_LOCK_PLL4_MASK       | \
        ANADIG_PLL_LOCK_PLL5_MASK       | \
        ANADIG_PLL_LOCK_PLL6_MASK       | \
        ANADIG_PLL_LOCK_PLL7_MASK       | \
        ANADIG_PLL_LOCK_PLL3_MASK)
...
static void ddr_init(void)
{
    ...
    ddrmc->CR97 = 0x01000000; //DDR_CR097
    ddrmc->CR98 = 0x00000000; //DDR_CR098
    ddrmc->CR99 = 0x00000000; //DDR_CR099
    ddrmc->CR102 = 0x00000000; //DDR_CR102
	...
	ddrmc->CR146 = 0x00000040; 	// rdlvl_res, rdlv_load, 
								// rdlv_dll, rdlv_en 
	ddrmc->CR147 = 0x000F0000; 	// relv_resp_mask 
	ddrmc->CR148 = 0x000F0000; 	// relv_en, 
								// redlv_gate_resp_mask, rdlv_gate_resp_mask 
	ddrmc->CR151 = 0x00000101;
	
    ddrmc->CR154 = 0x682C4000; // pad_zq: _early_cmp_en_timer, _mode, _hw_for, _cmp_out_smp
    ddrmc->CR155 = 0x00000012; // ReadOnly pad_ibe, _sel. pad_odt 
