...
{
    /* Enable XOSC oscillator for SNVS */
    SCSC_SOSC_CTR |= SCSC_SOSC_CTR_SOSC_EN_MASK;
...
)
{
    ...
    case 2: // I2C2
            ...
            IOMUXC_I2C2_IPP_SCL_IND_SELECT_INPUT = \
              (((uint32_t)(((uint32_t)(0))<<IOMUXC_I2C2_IPP_SCL_IND_SELECT_INPUT_DAISY_SHIFT))\
              &IOMUXC_I2C2_IPP_SCL_IND_SELECT_INPUT_DAISY_MASK);   // ALT6 - PAD_12
            IOMUXC_I2C2_IPP_SDA_IND_SELECT_INPUT = \
              (((uint32_t)(((uint32_t)(0))<<IOMUXC_I2C2_IPP_SDA_IND_SELECT_INPUT_DAISY_SHIFT))\
              &IOMUXC_I2C2_IPP_SDA_IND_SELECT_INPUT_DAISY_MASK);   // ALT6 - PAD_13
        break;
    case 3: // I2C3
            IOMUXC_RGPIO(20) =
                IOMUXC_SW_MUX_CTL_PAD_PAD_IBE(1)  |
