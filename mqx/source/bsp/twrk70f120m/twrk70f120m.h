...
*/
    ...
    */
    ...
    #define BSP_GS_SPI_BAUDRATE                 2900000
    /*
...
*/
    ...
    #define BSP_RSI_POWER_GPIO_PIN                  (LWGPIO_PORT_E | LWGPIO_PIN18 )
    #define BSP_RSI_POWER_MUX_GPIO                  (LWGPIO_MUX_E18_GPIO)

    #define BSP_RSI_RESET_GPIO_PIN                  (LWGPIO_PORT_E | LWGPIO_PIN19 )
    #define BSP_RSI_RESET_MUX_GPIO                  (LWGPIO_MUX_E19_GPIO)
