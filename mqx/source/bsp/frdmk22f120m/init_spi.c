...
#error It is not possible to configure SPI1 for the DMA mode on this platform due to RX/TX sharing the same DMA channel, see the Reference Manual for the K22F120M.
#endif
/*
