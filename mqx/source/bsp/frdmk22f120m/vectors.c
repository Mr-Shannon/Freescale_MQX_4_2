...
#endif /* CodeWarrior compiler assumed */
{
    ...
    DEFAULT_VECTOR,         /* 0x1C  0x00000070   -   ivINT_Reserved28                  */
    ...
    DEFAULT_VECTOR,         /* 0x2C  0x000000B0   -   ivINT_I2S0_TX                    */
    DEFAULT_VECTOR,         /* 0x2D  0x000000B4   -   ivINT_I2S0_RX                    */
    DEFAULT_VECTOR,         /* 0x2E  0x000000B8   -   ivINT_LPUART0_ERR              */
    DEFAULT_VECTOR,         /* 0x2F  0x000000BC   -   ivINT_UART0_RX_TX                 */
    DEFAULT_VECTOR,         /* 0x30  0x000000C0   -   ivINT_UART0_ERR                   */
    DEFAULT_VECTOR,         /* 0x31  0x000000C4   -   ivINT_UART1_RX_TX                 */
    DEFAULT_VECTOR,         /* 0x32  0x000000C8   -   ivINT_UART1_ERR                   */
    DEFAULT_VECTOR,         /* 0x33  0x000000CC   -   ivINT_UART2_RX_TX                 */
    DEFAULT_VECTOR,         /* 0x34  0x000000D0   -   ivINT_UART2_ERR                   */
    DEFAULT_VECTOR,         /* 0x35  0x000000D4   -   ivINT_Reserved53                  */
    DEFAULT_VECTOR,         /* 0x36  0x000000D8   -   ivINT_Reserved54                  */
    DEFAULT_VECTOR,         /* 0x37  0x000000DC   -   ivINT_ADC0                        */
    DEFAULT_VECTOR,         /* 0x38  0x000000E0   -   ivINT_CMP0                        */
    DEFAULT_VECTOR,         /* 0x39  0x000000E4   -   ivINT_CMP1                        */
    DEFAULT_VECTOR,         /* 0x3A  0x000000E8   -   ivINT_FTM0                        */
    DEFAULT_VECTOR,         /* 0x3B  0x000000EC   -   ivINT_FTM1                        */
    DEFAULT_VECTOR,         /* 0x3C  0x000000F0   -   ivINT_FTM2                        */
    DEFAULT_VECTOR,         /* 0x3D  0x000000F4   -   ivINT_Reserved61                  */
    DEFAULT_VECTOR,         /* 0x3E  0x000000F8   -   ivINT_RTC_ALARM                   */
    DEFAULT_VECTOR,         /* 0x3F  0x000000FC   -   ivINT_RTC_SECONDS               */
    DEFAULT_VECTOR,         /* 0x40  0x00000100   -   ivINT_PIT0                        */
    DEFAULT_VECTOR,         /* 0x41  0x00000104   -   ivINT_PIT1                        */
    DEFAULT_VECTOR,         /* 0x42  0x00000108   -   ivINT_PIT2                        */
    DEFAULT_VECTOR,         /* 0x43  0x0000010C   -   ivINT_PIT3                        */
    DEFAULT_VECTOR,         /* 0x44  0x00000110   -   ivINT_PDB                        */
    DEFAULT_VECTOR,         /* 0x45  0x00000114   -   ivINT_USB                        */
    DEFAULT_VECTOR,         /* 0x46  0x00000118   -   ivINT_Reserved70                  */
    DEFAULT_VECTOR,         /* 0x47  0x0000011C   -   ivINT_Reserved71                  */
    DEFAULT_VECTOR,         /* 0x48  0x00000120   -   ivINT_DAC0                        */
    DEFAULT_VECTOR,         /* 0x49  0x00000124   -   ivINT_MCG                         */
    DEFAULT_VECTOR,         /* 0x4A  0x00000128   -   ivINT_LPTimer                     */
    DEFAULT_VECTOR,         /* 0x4B  0x0000012C   -   ivINT_PORTA                       */
    DEFAULT_VECTOR,         /* 0x4C  0x00000130   -   ivINT_PORTB                       */
    DEFAULT_VECTOR,         /* 0x4D  0x00000134   -   ivINT_PORTC                       */
    DEFAULT_VECTOR,         /* 0x4E  0x00000138   -   ivINT_PORTD                       */
    DEFAULT_VECTOR,         /* 0x4F  0x0000013C   -   ivINT_PORTE                       */
    DEFAULT_VECTOR,         /* 0x50  0x00000140   -   ivINT_SOFTWARE                 */
    DEFAULT_VECTOR,         /* 0x51  0x00000144   -   ivINT_Reserved81                 */
    DEFAULT_VECTOR,         /* 0x52  0x00000148   -   ivINT_Reserved82                 */
    DEFAULT_VECTOR,         /* 0x53  0x0000014C   -   ivINT_Reserved83                 */
    DEFAULT_VECTOR,         /* 0x54  0x00000150   -   ivINT_Reserved84                 */
    DEFAULT_VECTOR,         /* 0x55  0x00000154   -   ivINT_Reserved85                 */
    DEFAULT_VECTOR,         /* 0x56  0x00000158   -   ivINT_Reserved86                 */
    DEFAULT_VECTOR,         /* 0x57  0x0000015C   -   ivINT_Reserved87                 */
    DEFAULT_VECTOR,         /* 0x58  0x00000160   -   ivINT_Reserved88                 */
    DEFAULT_VECTOR,         /* 0x59  0x00000164   -   ivINT_ADC1                         */
    DEFAULT_VECTOR,
    DEFAULT_VECTOR,
    DEFAULT_VECTOR,
    DEFAULT_VECTOR,
