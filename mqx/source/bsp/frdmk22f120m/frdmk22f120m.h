...
#ifndef _frdmk22f120m_h_
    #define _frdmk22f120m_h_  1
...
*/
#define BSP_LED1                    (GPIO_PORT_A | GPIO_PIN1) /* RED LED */
#define BSP_LED2                    (GPIO_PORT_A | GPIO_PIN2) /* GREEN LED */
#define BSP_LED3                    (GPIO_PORT_D | GPIO_PIN5) /* BLUE LED */

#define BSP_SW1                     (GPIO_PORT_C | GPIO_PIN1)
#define BSP_SW2                     (GPIO_PORT_B | GPIO_PIN17)
#define BSP_ACCEL_IRQ               (GPIO_PORT_D | GPIO_PIN0) /* onboard accelerometer IRQ pin */

#define BSP_LED1_MUX_GPIO           (LWGPIO_MUX_A1_GPIO)
#define BSP_LED2_MUX_GPIO           (LWGPIO_MUX_A2_GPIO)
#define BSP_LED3_MUX_GPIO           (LWGPIO_MUX_D5_GPIO)
#define BSP_SW1_MUX_GPIO            (LWGPIO_MUX_C1_GPIO)
#define BSP_SW2_MUX_GPIO            (LWGPIO_MUX_B17_GPIO)
#define BSP_ACCEL_MUX_GPIO          (LWGPIO_MUX_D0_GPIO)
...
#define BSP_SDCARD_GPIO_DETECT                        (GPIO_PORT_B | GPIO_PIN16)
#define BSP_SDCARD_DETECT_MUX_GPIO                    (LWGPIO_MUX_B16_GPIO)
#define BSP_SDCARD_DETECT_ACTIVE_LOW                  (1)

/* SPI0 FIFO size = 4 */
/* SPI1 FIFO size = 1 */
#ifndef DSPI_FIFO_DEPTH /* Added check for buildtests */
#define DSPI_FIFO_DEPTH                  (4)
    ...
    #warning SPI1 have 1 frames fifo, please define DSPI_FIFO_DEPTH to 1
#endif
