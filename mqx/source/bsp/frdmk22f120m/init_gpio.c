...
)
{
    ...
    switch (adc_num)
    {
        case 0:
            ...
            break;
        case 1:
            sim_ptr->SCGC6 |= SIM_SCGC6_ADC1_MASK;
            break;
        default:
            return IO_ERROR;
    }
...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            ...
            pctl->PCR[4] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;     /* DSPI0.PCS0   */
...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            ...
            pctl->PCR[2] = PORT_PCR_MUX(ALT2) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
            pctl->PCR[3] = PORT_PCR_MUX(ALT2) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
        ...
        case 1:
            ...
            pctl->PCR[11] = PORT_PCR_MUX(ALT2) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
            pctl->PCR[10] = PORT_PCR_MUX(ALT2) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
...
)
{
    switch(dev_num)
    {
        case 0:
            ...
            /* GPIO for SSI0_FS */
            PORTA_PCR13 |= PORT_PCR_MUX(0x06);                     /* Configure port for TX Frame Sync - Board REVA */
