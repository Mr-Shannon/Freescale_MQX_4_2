...
/* Define the extal clock src for RMII REF clock*/
#define BSP_EXTAL_RMII_REF_CLOCK        (50000000u)
...
*/
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PIN_PTB12)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_PTB12_GPIO)
...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_PWD_PIN       (LWGPIO_PIN_PTB26)
    #define BSP_PWD_PIN_MUX_GPIO                (LWGPIO_MUX_PTB26_GPIO)
    /* Corresponds to B62 on elevator */
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (LWGPIO_PIN_PTB12)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_PTB12_GPIO)
...
*/
    ...
    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PIN_PTB12)
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_PTB12_GPIO)
    #define BSP_RSI_WAKEUP_INT_LEVEL                (3)
    #define BSP_RSI_WAKEUP_INT_SUBLEVEL             (0)

    #define BSP_RSI_RESET_GPIO_PIN                  (LWGPIO_PIN_PTB10)
    #define BSP_RSI_RESET_MUX_GPIO                  (LWGPIO_MUX_PTB10_GPIO)

    #undef BSPCFG_ENABLE_SPI0
    #define BSPCFG_ENABLE_SPI0                      1

    /* TODO: currently SPI DMA does not work */
    #undef BSPCFG_DSPI0_USE_DMA
...
#endif
#define BSPCFG_NANDFLASH_NFC_INTERRUPT_VECTOR   INT_NFC
