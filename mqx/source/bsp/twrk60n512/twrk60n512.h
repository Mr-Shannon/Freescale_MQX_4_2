...
*/
    ...
    #define BSP_LAST_INTERRUPT_VECTOR_USED      INT_Reserved119
#endif
...
*/
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PORT_A | LWGPIO_PIN27)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_A27_GPIO)
...
*/
    ...
    #define BSP_PWD_PIN_MUX_GPIO                (LWGPIO_MUX_E28_GPIO)
    /* Corresponds to B62 on elevator */
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (GPIO_PORT_A|GPIO_PIN27)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_A27_GPIO)
...
*/
    ...
    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PORT_A | LWGPIO_PIN27 )
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_A27_GPIO)
    #define BSP_RSI_WAKEUP_INT_LEVEL                (3)
    #define BSP_RSI_WAKEUP_INT_SUBLEVEL             (0)

    #define BSP_RSI_POWER_GPIO_PIN                  (LWGPIO_PORT_C | LWGPIO_PIN19 )
    #define BSP_RSI_POWER_MUX_GPIO                  (LWGPIO_MUX_C19_GPIO)

    #define BSP_RSI_RESET_GPIO_PIN                  (LWGPIO_PORT_C | LWGPIO_PIN18 )
    #define BSP_RSI_RESET_MUX_GPIO                  (LWGPIO_MUX_C18_GPIO)
...
/*PPP_device used for communication with remote system using serial*/
#ifndef BSP_PPP_DEVICE
    #if BSPCFG_ENABLE_ITTYD
#define BSP_PPP_DEVICE                      "ittyd:"     /*RS-232 on TWR-SER     interrupt mode*/
        #define BSP_PPP_DEVICE_DEFINED
    #else
        #define BSP_PPP_DEVICE                      NULL
    #endif
#else
    /* undef is for backward compatibility with user_configh.h files which have already had it defined */
    #undef  BSP_PPP_DEVICE_DEFINED
    #define BSP_PPP_DEVICE_DEFINED
#endif
