...
*/
    ...
    #define BSP_LAST_INTERRUPT_VECTOR_USED      INT_I2S1_Rx
#endif
...
*/
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PORT_B | LWGPIO_PIN7)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_B7_GPIO)
...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (GPIO_PORT_B|GPIO_PIN7)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_B7_GPIO)
...
*/
    ...
    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PORT_B | LWGPIO_PIN7 )
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_B7_GPIO)
