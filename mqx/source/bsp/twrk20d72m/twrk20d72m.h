...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_PWD_PIN       (GPIO_PORT_B|GPIO_PIN20)
    #define BSP_PWD_PIN_MUX_GPIO                (LWGPIO_MUX_B20_GPIO)
...
*/
    ...
    #define BSP_RSI_POWER_GPIO_PIN                  (LWGPIO_PORT_C | LWGPIO_PIN9)
    #define BSP_RSI_POWER_MUX_GPIO                  (LWGPIO_MUX_C9_GPIO)

    #define BSP_RSI_RESET_GPIO_PIN                  (LWGPIO_PORT_C | LWGPIO_PIN7)
    #define BSP_RSI_RESET_MUX_GPIO                  (LWGPIO_MUX_C7_GPIO)
