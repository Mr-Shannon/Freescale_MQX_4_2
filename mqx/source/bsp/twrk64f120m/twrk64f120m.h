...
/*Select Can device support module*/
...
*/
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PORT_D | LWGPIO_PIN15)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_D15_GPIO)
...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (GPIO_PORT_D|GPIO_PIN15)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_D15_GPIO)
...
*/
    ...
    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PORT_D | LWGPIO_PIN15 )
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_D15_GPIO)
