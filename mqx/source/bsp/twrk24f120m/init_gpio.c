...
_mqx_int _bsp_i2c_io_init(uint32_t dev_num) {
   ...
   case 0:
      ...
      pctl->PCR[24] = PORT_PCR_MUX(5) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
      pctl->PCR[25] = PORT_PCR_MUX(5) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
   ...
   case 1:
      ...
      pctl->PCR[10] = PORT_PCR_MUX(2) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
      pctl->PCR[11] = PORT_PCR_MUX(2) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
   ...
   case 2:
      ...
      pctl->PCR[11] = PORT_PCR_MUX(5) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
      pctl->PCR[12] = PORT_PCR_MUX(5) | PORT_PCR_ODE_MASK | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
