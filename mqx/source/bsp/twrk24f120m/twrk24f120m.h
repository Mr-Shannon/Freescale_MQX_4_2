...
#ifndef _twrk24f120m_h_
    #define _twrk24f120m_h_  1
...
*/
#define BSP_TWR_K24F120M                     1
#define BSP_NAME                             "TWRK24F120M"
...
#ifndef BSPCFG_AUDIO_USE_ON_BOARD_CODEC
    #define BSPCFG_AUDIO_USE_ON_BOARD_CODEC         1
#endif

#if BSPCFG_AUDIO_USE_ON_BOARD_CODEC
    #undef  BSPCFG_ENABLE_I2C0
    #define BSPCFG_ENABLE_I2C0                      1
    #undef  BSPCFG_ENABLE_SAI
...
*/
    ...
    #define BSPCFG_I2C_USE_ON_BOARD_MEMORY          1
#endif
...
*/
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PORT_B | LWGPIO_PIN20)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_B20_GPIO)
...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (GPIO_PORT_B|GPIO_PIN20)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_B20_GPIO)
...
*/
    ...
    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PORT_B | LWGPIO_PIN20)
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_B20_GPIO)
