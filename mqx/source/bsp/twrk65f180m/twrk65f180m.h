...
*   Freescale TWR-K65F180M Evaluation board.
*
*
*END************************************************************************/

#ifndef _twrk65f180m_h_
    #define _twrk65f180m_h_  1
...
*/
#define BSP_TWR_K65F180M                     1
#define BSP_NAME                            "TWRK65F180M"
...
#define __EXTERNAL_MRAM_ROM_SIZE 0x00060000
#define __EXTERNAL_MRAM_RAM_BASE 0x60000000
#define __EXTERNAL_MRAM_RAM_SIZE 0x00020000
#define __EXTERNAL_LCD_BASE      0xA0010000
#define __EXTERNAL_LCD_SIZE      0x0001FFFF
#define __EXTERNAL_LCD_DC_BASE   0x70000000
...
#define BSP_SDRAM_BASE                      (0x70000000U)
#define BSP_SDRAM_SIZE                      (0x00800000U)
...
*/
#define BSP_LED1                    (GPIO_PORT_B | GPIO_PIN4)
#define BSP_LED2                    (GPIO_PORT_B | GPIO_PIN5)
#define BSP_LED3                    (GPIO_PORT_A | GPIO_PIN28)
#define BSP_LED4                    (GPIO_PORT_A | GPIO_PIN29)

#define BSP_SW2                     (GPIO_PORT_A | GPIO_PIN4)
#define BSP_SW3                     (GPIO_PORT_A | GPIO_PIN10)
#define BSP_ACCEL_IRQ1              (GPIO_PORT_E | GPIO_PIN27) /* onboard accelerometer IRQ pin */
#define BSP_ACCEL_IRQ2              (GPIO_PORT_E | GPIO_PIN28) /* onboard accelerometer IRQ pin */


#define BSP_LED1_MUX_GPIO           (LWGPIO_MUX_B4_GPIO)
#define BSP_LED2_MUX_GPIO           (LWGPIO_MUX_B5_GPIO)
#define BSP_LED3_MUX_GPIO           (LWGPIO_MUX_A28_GPIO)
#define BSP_LED4_MUX_GPIO           (LWGPIO_MUX_A29_GPIO)
#define BSP_SW2_MUX_GPIO            (LWGPIO_MUX_A4_GPIO)
#define BSP_SW3_MUX_GPIO            (LWGPIO_MUX_A10_GPIO)
#define BSP_ACCEL_MUX_GPIO1         (LWGPIO_MUX_E27_GPIO)
#define BSP_ACCEL_MUX_GPIO2         (LWGPIO_MUX_E28_GPIO)
...
#define BSP_BUTTON1_MUX_IRQ         BSP_SW3_MUX_GPIO
...
*/
    ...
    */
    #define BSP_GS_SPI_DEVICE                   "spi2:"
    #define BSP_GS_SPI_BAUDRATE                 2500000
    /*
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PORT_E | LWGPIO_PIN28)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_E28_GPIO)
...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_PWD_PIN       (GPIO_PORT_D|GPIO_PIN10)
    #define BSP_PWD_PIN_MUX_GPIO                (LWGPIO_MUX_D10_GPIO)
    /* Corresponds to B62 on elevator */
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (GPIO_PORT_E|GPIO_PIN28)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_E28_GPIO)
...
*/
    ...
    #define BSP_RSI_SPI_DEVICE                      "spi2:"

    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PORT_E | LWGPIO_PIN28 )
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_E28_GPIO)
    #define BSP_RSI_WAKEUP_INT_LEVEL                (3)
    #define BSP_RSI_WAKEUP_INT_SUBLEVEL             (0)

    #define BSP_RSI_POWER_GPIO_PIN                  (LWGPIO_PORT_E | LWGPIO_PIN10 )
    #define BSP_RSI_POWER_MUX_GPIO                  (LWGPIO_MUX_E10_GPIO)

    #define BSP_RSI_RESET_GPIO_PIN                  (LWGPIO_PORT_E | LWGPIO_PIN11 )
    #define BSP_RSI_RESET_MUX_GPIO                  (LWGPIO_MUX_E11_GPIO)
    ...
    #define BSP_RSI_SPI_USE_DMA                     BSPCFG_DSPI2_USE_DMA
...
#define BSP_SDCARD_GPIO_DETECT              (GPIO_PORT_A | GPIO_PIN9)
#define BSP_SDCARD_DETECT_MUX_GPIO          (LWGPIO_MUX_A9_GPIO)

/*-----------------------------------------------------------------------------
**                      I2C
*/
#define BSP_I2C_CLOCK                       (BSP_BUS_CLOCK)
#define BSP_I2C0_ADDRESS                    (0x6C)
#define BSP_I2C1_ADDRESS                    (0x6D)
#define BSP_I2C2_ADDRESS                    (0x6E)
#define BSP_I2C3_ADDRESS                    (0x6F)
...
#define BSP_ADC_POTENTIOMETER           (ADC1_SOURCE_AD16)
#define BSP_ADC_CH_POT                  (ADC1_SOURCE_AD16)
...
/* USB host controler for K65x processors */
