...
*/
    ...
    */
    #define BSP_GS_WAKEUP_GPIO_PIN              (LWGPIO_PORT_B | LWGPIO_PIN8)
    #define BSP_GS_WAKEUP_MUX_IRQ               (LWGPIO_MUX_B8_GPIO)
    #define BSP_GS_WAKEUP_INT_LEVEL             (3)
    #define BSP_GS_WAKEUP_INT_SUBLEVEL          (0)

    /*
    * GPIO pin to reset GS chip at A63 - ELEV
    */
    #define BSP_GS_CHIP_RESET_PIN               (LWGPIO_PORT_C | LWGPIO_PIN18)
    #define BSP_GS_CHIP_RESET_MUX_GPIO          (LWGPIO_MUX_C18_GPIO)
...
*/
    ...
    #define BSP_ATHEROS_WIFI_GPIO_INT_PIN       (GPIO_PORT_B|GPIO_PIN8)
    #define BSP_INT_PIN_MUX_GPIO                (LWGPIO_MUX_B8_GPIO)
...
*/
    ...
    #define BSP_RSI_WAKEUP_GPIO_PIN                 (LWGPIO_PORT_B | LWGPIO_PIN8)
    #define BSP_RSI_WAKEUP_MUX_IRQ                  (LWGPIO_MUX_B8_GPIO)
