...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.iar/debug/mcc/mcc.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.iar/release/mcc/mcc.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.iar/debug/mcc
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.iar/release/mcc
endif
