...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk20d72m.iar/release/shell
