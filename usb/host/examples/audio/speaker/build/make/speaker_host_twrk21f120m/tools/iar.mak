...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.iar/release/shell
