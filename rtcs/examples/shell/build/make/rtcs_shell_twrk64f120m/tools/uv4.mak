...
LIBRARIES_NODEPS += $(MQX_ROOTDIR)/lib/twrk64f120m.uv4/debug/bsp/bsp.lib(vectors.o)
LIBRARIES_NODEPS += $(MQX_ROOTDIR)/lib/twrk64f120m.uv4/debug/psp/psp.lib(linker_symbols.o)
...
LIBRARIES_NODEPS += $(MQX_ROOTDIR)/lib/twrk64f120m.uv4/release/bsp/bsp.lib(vectors.o)
LIBRARIES_NODEPS += $(MQX_ROOTDIR)/lib/twrk64f120m.uv4/release/psp/psp.lib(linker_symbols.o)
RT_PATHS += $(TOOLCHAIN_ROOTDIR)/ARM/ARMCC/lib/
endif
