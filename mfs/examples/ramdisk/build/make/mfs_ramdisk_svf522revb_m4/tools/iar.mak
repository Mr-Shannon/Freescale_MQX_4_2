...
LIBRARIES += $(MQX_ROOTDIR)/lib/svf522revb_m4.iar/debug/shell/shell.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/svf522revb_m4.iar/release/shell/shell.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/svf522revb_m4.iar/debug/shell
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/svf522revb_m4.iar/release/shell
endif
