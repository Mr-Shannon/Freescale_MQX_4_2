...
LIBRARIES += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/debug/shell/shell.a
...
LIBRARIES += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/release/shell/shell.a
...
INCLUDE += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/svf522revb_m4.ds5/release/shell
INCLUDE += $(TOOLCHAIN_ROOTDIR)/include
endif
