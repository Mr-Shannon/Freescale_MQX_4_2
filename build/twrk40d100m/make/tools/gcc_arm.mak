...
# common settings
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -Xassembler --no-warn -std=gnu99 -Wall -mthumb -gdwarf-2 -gstrict-dwarf -g2 
CC_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -fno-strict-aliasing -Wno-missing-braces -std=gnu99 -nostdinc -ffunction-sections -fdata-sections -Wall -mthumb -gdwarf-2 -gstrict-dwarf -g2 
...
CC_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -fno-strict-aliasing -Wno-missing-braces -std=gnu99 -nostdinc -ffunction-sections -fdata-sections -Wall -mthumb -gdwarf-2 -gstrict-dwarf -g2 
CX_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -fno-strict-aliasing -Wno-missing-braces -nostdinc -nostdinc++ -fno-exceptions -ffunction-sections -fdata-sections -Wall -mthumb -gdwarf-2 -gstrict-dwarf -g2 
LD_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -nostartfiles -nodefaultlibs -nostdlib -Xlinker --gc-sections -Xlinker -cref -Xlinker -static -mthumb -gdwarf-2 -gstrict-dwarf -Xlinker -z -Xlinker muldefs -g2 
CC_DEFINE += _AEABI_LC_CTYPE=C __STRICT_ANSI__=1 
CX_DEFINE += _AEABI_LC_CTYPE=C __STRICT_ANSI__=1 
