...
# common settings
AS_FLAGS += -proc 52259 -sym full -msgstyle parseable -nosyspath 
CC_FLAGS += -proc 52259 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c99 -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -requireprotos -noscheduling -nopeephole 
CX_FLAGS += -proc 52259 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c++ -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -requireprotos -noscheduling -nopeephole 
AR_FLAGS += -proc 52259 -library -sym full -msgstyle parseable -nostdlib -map -srec -sreclength 80 -sreceol dos -keep off -w on 
...
CC_FLAGS += -proc 52259 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c99 -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -requireprotos -noscheduling -nopeephole 
CX_FLAGS += -proc 52259 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c++ -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -requireprotos -noscheduling -nopeephole 
LD_FLAGS += -proc 52259 -sym full -msgstyle parseable -lavender model=c9x ,print=int ,scan=int ,io=raw -nostdlib -m ___boot -map -map closure -srec -sreclength 80 -sreceol dos -w off 
AS_DEFINE += _EWL_C99=1 _EMBEDDED_WARRIOR_CTYPE=0 _EWL_FLOATING_POINT=1 __CODEWARRIOR__=1 
CC_DEFINE += _EWL_C99=1 _EMBEDDED_WARRIOR_CTYPE=0 _EWL_FLOATING_POINT=1 __CODEWARRIOR__=1 
CX_DEFINE += _EWL_C99=1 _EMBEDDED_WARRIOR_CTYPE=0 _EWL_FLOATING_POINT=1 __CODEWARRIOR__=1 
