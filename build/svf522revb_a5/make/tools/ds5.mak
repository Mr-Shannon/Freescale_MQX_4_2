...
# common settings
AS_FLAGS += --cpu=Cortex-A5.neon --fpu=vfpv4 --cpreproc --apcs=/interwork -g 
CC_FLAGS += --cpu=Cortex-A5.neon --fpu=vfpv4 --vectorize --diag_suppress=1296,186 --c99 --thumb --apcs=/interwork -g 
CX_FLAGS += --cpu=Cortex-A5.neon --fpu=vfpv4 --vectorize --diag_suppress=1296,186,368 --cpp --thumb --apcs=/interwork -g 
...
CC_FLAGS += --cpu=Cortex-A5.neon --fpu=vfpv4 --vectorize --diag_suppress=1296,186 --c99 --thumb --apcs=/interwork -g 
CX_FLAGS += --cpu=Cortex-A5.neon --fpu=vfpv4 --vectorize --diag_suppress=1296,186,368 --cpp --thumb --apcs=/interwork -g 
LD_FLAGS += --cpu=Cortex-A5.neon --fpu=vfpv4 --keep linker_symbols.o(KERNEL_DATA_START) --keep linker_symbols.o(KERNEL_DATA_END) --keep linker_symbols.o(BOOT_STACK) --diag_suppress=6314,6329 --info debug,sizes,totals,unused,veneers --map --symbols --entry __boot --debug 
