...
LIBRARIES += $(MQX_ROOTDIR)/usb_v2/output/twrvf65gs10_a5.gcc_arm/debug/usbh/mqx/libusbh_mqx.a
...
LIBRARIES += $(MQX_ROOTDIR)/usb_v2/output/twrvf65gs10_a5.gcc_arm/release/usbh/mqx/libusbh_mqx.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/lib/gcc/arm-none-eabi/$(GCC_VERSION)/armv7-ar/thumb/fpu/libgcc.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/arm-none-eabi/lib/armv7-ar/thumb/fpu/libc.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/arm-none-eabi/lib/armv7-ar/thumb/fpu/libsupc++.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/arm-none-eabi/lib/armv7-ar/thumb/fpu/libm.a
...
INCLUDE += $(MQX_ROOTDIR)/usb_v2/output/twrvf65gs10_a5.gcc_arm/debug/usbh/mqx
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/usb_v2/output/twrvf65gs10_a5.gcc_arm/release/usbh/mqx
endif
