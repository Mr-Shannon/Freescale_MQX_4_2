...
LIBRARIES += $(MQX_ROOTDIR)/usb_v2/output/twrk64f120m.gcc_arm/debug/usbh/mqx/libusbh_mqx.a
...
LIBRARIES += $(MQX_ROOTDIR)/usb_v2/output/twrk64f120m.gcc_arm/release/usbh/mqx/libusbh_mqx.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/lib/gcc/arm-none-eabi/$(GCC_VERSION)/armv7e-m/fpu/libgcc.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/arm-none-eabi/lib/armv7e-m/fpu/libc.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/arm-none-eabi/lib/armv7e-m/fpu/libsupc++.a
LIBRARIES += $(TOOLCHAIN_ROOTDIR)/arm-none-eabi/lib/armv7e-m/fpu/libm.a
...
INCLUDE += $(MQX_ROOTDIR)/usb_v2/output/twrk64f120m.gcc_arm/debug/usbh/mqx
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/usb_v2/output/twrk64f120m.gcc_arm/release/usbh/mqx
endif
