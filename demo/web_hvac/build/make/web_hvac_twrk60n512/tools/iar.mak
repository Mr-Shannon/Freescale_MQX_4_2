...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.iar/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.iar/release/shell
