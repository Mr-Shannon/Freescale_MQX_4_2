...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/twrk22f120m.gcc_arm/debug/usbotg/mqx/libusbotg_mqx.a
...
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/twrk22f120m.gcc_arm/release/usbotg/mqx/libusbotg_mqx.a
