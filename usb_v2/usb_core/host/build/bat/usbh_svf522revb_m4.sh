...
cp -f "${ROOTDIR}/usb_core/host/include/svf522revb_m4/usb_host_config.h" "${OUTPUTDIR}/usb_host_config.h"
...
# ds5 files
if [ "${TOOL}" = "ds5" ]; then
cp -f "${ROOTDIR}/usb_core/host/build/ds5/usbh_mqx_svf522revb_m4/${TARGET}/libusbh_mqx.a" "${OUTPUTDIR}/libusbh_mqx.a"
:
fi
