...
cp -f "${ROOTDIR}/usb_core/host/include/twrvf65gs10_a5/usb_host_config.h" "${OUTPUTDIR}/usb_host_config.h"
...
# ds5 files
if [ "${TOOL}" = "ds5" ]; then
cp -f "${ROOTDIR}/usb_core/host/build/ds5/usbh_mqx_twrvf65gs10_a5/${TARGET}/libusbh_mqx.a" "${OUTPUTDIR}/libusbh_mqx.a"
:
fi
