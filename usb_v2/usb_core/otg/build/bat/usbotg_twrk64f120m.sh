...
cp -f "${ROOTDIR}/usb_core/device/include/twrk64f120m/usb_device_config.h" "${OUTPUTDIR}/usb_device_config.h"
...
cp -f "${ROOTDIR}/usb_core/host/include/twrk64f120m/usb_host_config.h" "${OUTPUTDIR}/usb_host_config.h"
