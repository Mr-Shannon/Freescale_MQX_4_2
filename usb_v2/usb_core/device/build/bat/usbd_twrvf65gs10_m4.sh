...
cp -f "${ROOTDIR}/usb_core/device/include/twrvf65gs10_m4/usb_device_config.h" "${OUTPUTDIR}/usb_device_config.h"
...
# ds5 files
if [ "${TOOL}" = "ds5" ]; then
cp -f "${ROOTDIR}/usb_core/device/build/ds5/usbd_mqx_twrvf65gs10_m4/${TARGET}/libusbd_mqx.a" "${OUTPUTDIR}/libusbd_mqx.a"
:
fi
