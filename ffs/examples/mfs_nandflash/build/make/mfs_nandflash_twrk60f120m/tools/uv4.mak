...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/mfs/mfs.lib
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/ffs/ffs.lib
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/shell/shell.lib
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/mfs/mfs.lib
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/ffs/ffs.lib
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/shell/shell.lib
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/ffs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/ffs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/shell
INCLUDE += $(TOOLCHAIN_ROOTDIR)/ARM/ARMCC/include
endif
